                ...
                <form id="form_menu_guardar" method="post" class="form_menu_guardar">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <label>Nombre</label>
                            <input type="text" class="form-control" id="modulo_nombre"  name="modulo_nombre" placeholder="Ingresar Nombre" value="<%=_character.CharacterUCFirst(menu.getNombre())%>">                            
                        </div>                        
                        <div class="form-group">
                            <label>Estado</label>
                            <%
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="modulo_posicion" name="modulo_posicion" placeholder="Ingresar PosiciÛn" value="<%=menu.getPosicion()%>">
                        </div>

                        <div class="form-group">
                            <label>Ãcono</label>
                            <input type="text" class="form-control"  id="modulo_icono" name="modulo_icono" placeholder="Icono" value="<%=menu.getIcono()%>">
                        </div>                        
                    </div>
                    <!-- /.box-body -->
