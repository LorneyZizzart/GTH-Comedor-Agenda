<%-- 
    Document   : index
    Created on : 23/05/2019, 03:53:13 PM
    Author     : pc
--%>
                ...
                <div class="box-body table-responsive">
                    <table id="example1" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            %>
                        <tr style="cursor:pointer;" class='clickable-row' data-href="historialFuncionario.jsp?i=<%=_encript.ValorAEncriptar(Integer.toString(item.getEmpleado_id()))%>">
                                <td><%=contador%></td>
