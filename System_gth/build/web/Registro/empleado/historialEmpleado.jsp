...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="./index.jsp"><i class="fa fa-th-list"></i> Lista de empleados</a></li>
        ...
        <div class="col-md-3">
          ...
          <div class="box">
            ...
            <div class="box-body">
               ...
               <p class="pull-right"><%=_character.CharacterUCFirst(item.getCargo())%></p>
              <hr>
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="#timeline" data-toggle="tab">Otra opcion</a></li>
              <li><a href="#settings" data-toggle="tab">Siguiente opcion</a></li>
            </ul>
