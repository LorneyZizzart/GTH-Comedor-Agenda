                ...
                <div class="box-body">
                    ...
                    <div class="form-group col-md-3" >                                            
                                        ...
                                        <div class="form-group col-md-3">                                            
                                            ...
                                            <label>Requiere voto de comisiÛn administrativa</label>
                                        </div>
                                        <div class="form-group col-md-3">                                            
                                            <input type="checkbox" name="requiereFIE" id="requiereFIE"  class="flat-red"> 
                                            <label>Requiere formulario impreso especÌfico</label>
                                        </div>
                                        <div class="form-group col-md-3">                                           
                                            <input type="checkbox" name="requiereFDE" id="requiereFDE"  class="flat-red">
                                            <label>Requiere formulario digital especÌfico</label>
                                        </div>
                                            <div style="padding: 10px; position: relative; display: flow-root;">
                    <a style="cursor:pointer;" class="formNuevo btn-purple pull-right" data-toggle="modal tooltip" data-target="#modal-default" data-placement="bottom" title="AÒadir procedimiento">
