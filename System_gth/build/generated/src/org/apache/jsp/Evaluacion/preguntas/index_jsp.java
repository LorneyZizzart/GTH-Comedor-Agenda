...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/Evaluacion/preguntas/../../masterPage/complemento/head.jsp");
    _jspx_dependants.add("/Evaluacion/preguntas/../../masterPage/complemento/menu.jsp");
    _jspx_dependants.add("/Evaluacion/preguntas/../../masterPage/complemento/footer.jsp");
  }
 ...
 DatoUsuario = (Login_Entidad) sesion.getAttribute("USUARIO");
      ...
      out.write('\n');
      Controlador.TipoController _tipóPregunta = null;
      synchronized (_jspx_page_context) {
        _tipóPregunta = (Controlador.TipoController) _jspx_page_context.getAttribute("_tipóPregunta", PageContext.PAGE_SCOPE);
        if (_tipóPregunta == null){
          _tipóPregunta = new Controlador.TipoController();
          _jspx_page_context.setAttribute("_tipóPregunta", _tipóPregunta, PageContext.PAGE_SCOPE);
        }
      }
      out.write('\n');
    ...
    try {
      ...
      out.write("        <li class=\"active\">Preguntas</li>\n");
      out.write("    </ol>\n");
      out.write("</section>\n");
      ...
      out.print(_encript.ValorAEncriptar(Integer.toString(idCuestionario)));
      out.write("\" name=\"idCuestionario\" id=\"idCuestionario\">\n");
      out.write("                <input type=\"hidden\" value=\"");
      out.print(_encript.ValorAEncriptar(Integer.toString(idPregunta)));
      ...
      out.write("                        </div>\n");
      out.write("                        <button type=\"submit\" class=\"btn-purple btn-block\"><i class=\"fa fa-plus\"></i><b> Agregar pregunta</b></button>\n");
      out.write("\n");
      out.write("                    </div>\n");
      out.write("                    <!-- /.box-body -->\n");
      out.write("                </div>\n");
      ...
      out.write("                    <h3 class=\"box-title\">Lista de preguntas</h3>\n");
      out.write("\n");
      out.write("                    <div class=\"box-tools pull-right btn-enviar\">\n");
      out.write("                        <a href=\"../EnviarCuestionario/index.jsp?e=");
      out.print(_encript.ValorAEncriptar(Integer.toString(cuestionario.getCuestionario_id())));
      out.write("\" class=\"btn-purple\"><i class=\"fa fa-paper-plane\"></i> Enviar</a>\n");
      out.write("                    </div>\n");
      out.write("                    <!-- /.box-tools -->\n");
      out.write("                </div>\n");
      ...
      out.write("</td>\n");
      out.write("                                <td>");
      out.print(item.getNombre_tipo_id());
      out.write("</td>\n");
      out.write("                                <td>");
      out.print(item.getNombre());
      out.write("</td>\n");
      out.write("                                <td>");
      out.print(item.getOrden());
      out.write("</td>\n");
      out.write("                                <td>");
 if (item.getEstado() == 1) {
      ...
      out.write("                                <a data-id=\"");
      out.print(_encript.ValorAEncriptar(Integer.toString(item.getPregunta_id())));
      ...
      out.write("\" class=\"formDelet btn btn-danger btn-xs delete_button\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Eliminar\"> <i class=\"fa fa-trash-o\"></i></a>                                \n");
      out.write("                            </div>\n");
      out.write("                        </td>\n");
      out.write("                        </tr>\n");
      out.write("                        ");
      ...
      out.write("        $(\"#titleModal\").html(\"Editar pregunta\");\n");
      out.write("        e.preventDefault();\n");
      ...
      out.write("        $.post('editarPregunta.jsp',\n");
      out.write("                {id: $(this).attr('data-id'), idUser: idUser, idCuestionario: $(\"#idCuestionario\").val()},\n");
      out.write("        function (html) {\n");
      ...
      out.write("        $(\"#titleModal\").html(\"Eliminar pregunta\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("\n");
      out.write("        $('#formulario_registro').modal('show');\n");
      ...
      out.write("        $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("        var idUser = $(\"#idUsuario\").val();\n");
      out.write("        $.post('eliminarPregunta.jsp',\n");
