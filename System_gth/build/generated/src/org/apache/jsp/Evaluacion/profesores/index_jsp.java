...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/Evaluacion/profesores/../../masterPage/complemento/head.jsp");
    _jspx_dependants.add("/Evaluacion/profesores/../../masterPage/complemento/menu.jsp");
    _jspx_dependants.add("/Evaluacion/profesores/../../masterPage/complemento/footer.jsp");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write('\n');
      Controlador.Unidad_academicaController u_acadcontroller = null;
      synchronized (_jspx_page_context) {
        u_acadcontroller = (Controlador.Unidad_academicaController) _jspx_page_context.getAttribute("u_acadcontroller", PageContext.PAGE_SCOPE);
        if (u_acadcontroller == null){
          u_acadcontroller = new Controlador.Unidad_academicaController();
          _jspx_page_context.setAttribute("u_acadcontroller", u_acadcontroller, PageContext.PAGE_SCOPE);
        }
      }
      out.write('\n');
      out.write('\n');
    ...
    unidades = u_acadcontroller.GetAllUnidadAcademica();
      ...
      out.write("    <h1>\n");
      out.write("        Evaluación\n");
      out.write("        <small> Profesores</small>\n");
      out.write("    </h1>\n");
      out.write("    <ol class=\"breadcrumb\">\n");
      out.write("        <li><a href=\"../../\"><i class=\"fa fa-dashboard\"></i> Inicio</a></li>\n");
      out.write("        <li class=\"active\">Evaluación Profesores</li>\n");
      out.write("    </ol>\n");
      out.write("</section>\n");
      out.write("<section class=\"content\">\n");
      out.write("    <div class=\"box box-purple\">\n");
      out.write("        <div class=\"box-header\">\n");
      out.write("            <h3 class=\"box-title\">Lista de profesores</h3>            \n");
      out.write("        </div>\n");
      out.write("        <!-- /.box-header -->\n");
      out.write("        <div class=\"form-inline text-center\">\n");
      out.write("            <div class=\"form-group\">\n");
      out.write("                <label>Gestión</label>\n");
      out.write("                <select class=\"form-control gestion\">\n");
      out.write("                    <option value=\"0\">Seleccione gestión</option>\n");
      out.write("                    <option value=\"2020-1\">2020-1</option>\n");
      out.write("                    <option value=\"2019-2\">2019-2</option>\n");
      out.write("                    <option value=\"2019-1\">2019-1</option>\n");
      out.write("                </select>\n");
      out.write("            </div>\n");
      out.write("            <div class=\"form-group\">\n");
      out.write("                <label for=\"exampleInputEmail2\">Área</label>\n");
      out.write("                <select class=\"form-control area\">\n");
      out.write("                    <option value=\"0\">Seleccione área</option>\n");
      out.write("                    ");
      ...
      out.print(u.getUnidad_academica_id());
      out.write('"');
      out.write('>');
      ...
      out.write("                </select>\n");
      out.write("            </div>\n");
      out.write("            <button type=\"submit\" class=\"btn btn-purple btn_buscar_prof\">Buscar</button>\n");
      out.write("        </div>.\n");
      out.write("        <section class=\"lista_profes\">\n");
      out.write("\n");
      out.write("        </section>.\n");
      out.write("    </div>\n");
      out.write("</section>\n");
      ...
      out.write("\n");
      out.write("\n");
      out.write("    $('.btn_buscar_prof').click(function () {\n");
      out.write("        var gestion = $(\".gestion\").val();\n");
      out.write("        var area = $(\".area\").val();\n");
      out.write("        if (gestion !== '0') {\n");
      out.write("            $(\".lista_profes\").html('');\n");
      out.write("            $(\".lista_profes\").addClass('loader');\n");
      out.write("\n");
      out.write("            $.post('lista_prof_gestion.jsp',\n");
      out.write("                    {gestion: gestion,\n");
      out.write("                        area: area},\n");
      out.write("                    function (html) {\n");
      out.write("                        $(\".lista_profes\").html(html);\n");
      out.write("                        $(\".lista_profes\").removeClass('loader');\n");
      out.write("                    }\n");
      out.write("            ).fail(function (jqXHR, textStatus, errorThrown)\n");
      out.write("            {\n");
      out.write("                var alerta = \"<p class='bg-danger'>error: \" + errorThrown + \"</p>\";\n");
      out.write("                $(\".lista_profes\").removeClass('loader');\n");
      out.write("                $(\".lista_profes\").html(alerta);\n");
      out.write("            });\n");
      out.write("        } else {\n");
