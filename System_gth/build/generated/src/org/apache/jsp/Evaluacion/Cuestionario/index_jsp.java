...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/Evaluacion/Cuestionario/../../masterPage/complemento/head.jsp");
    _jspx_dependants.add("/Evaluacion/Cuestionario/../../masterPage/complemento/menu.jsp");
    _jspx_dependants.add("/Evaluacion/Cuestionario/../../masterPage/complemento/footer.jsp");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    listaCuestionario = _cuestionario.GetAllCuestionario();
      ...
      out.write("    <h1>\n");
      out.write("        Registro\n");
      out.write("        <small> de Cuestionarios</small>\n");
      out.write("    </h1>\n");
      out.write("    <ol class=\"breadcrumb\">\n");
      out.write("        <li><a href=\"#\"><i class=\"fa fa-dashboard\"></i> Inicio</a></li>\n");
      out.write("        <li class=\"active\">Lista de cuestionarios</li>\n");
      out.write("    </ol>\n");
      out.write("</section>\n");
      ...
      out.write("                    <h3 class=\"box-title\">Lista de cuestionarios</h3>\n");
      out.write("                    <a data-id=\"");
      out.print(_encript.ValorAEncriptar(Integer.toString(DatoUsuario.getUser_id())));
      out.write("\" class=\"formNuevo btn-purple btn-right_nivel\" data-toggle=\"modal tooltip\" data-target=\"#modal-default\" data-placement=\"bottom\" title=\"Añadir cuestionario\">\n");
      ...
      out.write("\n");
      out.write("                            <tr style=\"cursor:pointer;\" class='clickable-row' data-href=\"../preguntas/index.jsp?c=");
      out.print(_encript.ValorAEncriptar(Integer.toString(item.getCuestionario_id())));
      out.write("\">\n");
      out.write("                                <td>");
      out.print(contador);
      out.write("</td>\n");
      ...
      out.print(elem.getSector_nombre());
      out.write("</span>\n");
      out.write("                                    \n");
      out.write("                                    ");
...
String idEncripta = _encript.ValorAEncriptar(Integer.toString(item.getCuestionario_id()));
      out.write(" \n");
      out.write("                                <a href=\"../preguntas/index.jsp?c=");
      out.print(idEncripta);
      out.write("\" class=\"btn btn-xs btn-info\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Añadir preguntas\"><i class=\"fa fa-plus\"></i></a> \n");
      out.write("                                <!--<a href=\"../EnviarCuestionario/index.jsp?e=");
      out.print(idEncripta);
      out.write("\" class=\"btn btn-xs btn-success\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Enviar cuestionario\"><i class=\"fa fa-paper-plane\"></i></a>   -->\n");
      out.write("                                <a data-id=\"");
      out.print(idEncripta);
      out.write("\" class=\"formEdit btn btn-xs btn-primary\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Editar\"><i class=\"fa fa-edit\"></i></a>                                \n");
      out.write("                                <a data-id=\"");
      out.print(idEncripta);
      ...
      out.write("        $(\"#titleModal\").html(\"Nuevo cuestionario\");\n");
      ...
      out.write("\n");
      out.write("        $.post('crearCuestionario.jsp',\n");
      ...
      out.write("        $(\"#titleModal\").html(\"Editar cuestionario\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("\n");
      out.write("        $('#formulario_registro').modal('show');\n");
      ...
      out.write("        $.post('editarCuestionario.jsp',\n");
      ...
      out.write("        $(\"#titleModal\").html(\"Eliminar cuestionario\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("\n");
      out.write("        $('#formulario_registro').modal('show');\n");
      ...
      out.write("        $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("\n");
      out.write("        $.post('eliminarCuestionario.jsp',\n");
      out.write("                {id: $(this).attr('data-id')},\n");
      out.write("                function (html) {\n");
      out.write("                    $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                    $(\".cuerpo_registro\").html(html);\n");
