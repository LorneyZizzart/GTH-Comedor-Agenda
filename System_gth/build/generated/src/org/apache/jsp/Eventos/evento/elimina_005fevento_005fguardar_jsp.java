...
public final class elimina_005fevento_005fguardar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write('\n');
      Controlador.EventoController eliminaEvento = null;
      synchronized (_jspx_page_context) {
        eliminaEvento = (Controlador.EventoController) _jspx_page_context.getAttribute("eliminaEvento", PageContext.PAGE_SCOPE);
        if (eliminaEvento == null){
          eliminaEvento = new Controlador.EventoController();
          _jspx_page_context.setAttribute("eliminaEvento", eliminaEvento, PageContext.PAGE_SCOPE);
        }
      }
      out.write('\n');
