...
public final class persona_005flista_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    Empleados = consultaEvento.GetAllEmpleadoEvento(e_evento_id);
      ...
      out.write("                    <button id=\"formNuevoArea\" type=\"button\" class=\"btn-purple btn-right_nivel\" data-id=\"");
      out.print(e_evento_id);
      out.write("\" data-toggle=\"modal tooltip\" data-target=\"#modal-default\" data-placement=\"bottom\" title=\"Añadir Participantes\">\n");
      ...
      out.write("                            <tr>\n");
      out.write("                                <th>#</th>\n");
      out.write("                                <th>Nombre participante</th>\n");
      ...
      out.write("\" class=\"empleado_elimina btn btn-xs btn-danger delete_button\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Eliminar\"> <i class=\"fa fa-trash-o\"></i></a></td>\n");
      out.write("                            </tr>\n");
      out.write("                            ");
      ...
      out.write("            $(\"#titleModal\").html(\"Añadir Participantes\");\n");
      out.write("            $('#registro_persona_evento').modal('show');\n");
      out.write("            $(\".cuerpo_registro\").html('');\n");
      out.write("            $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("            //$.post('lista_cuenta_duplicada.jsp',\n");
      out.write("            $.post('personas_no_seleccionadas.jsp',\n");
      ...
      out.write("        });\n");
      out.write("\n");
      out.write("        $('.empleado_elimina').click(function () {\n");
      out.write("            var emple_id = $(this).attr('data-id');\n");
      out.write("\n");
      out.write("            $.post('persona_elimina_de_evento.jsp',\n");
      out.write("                    {id: $(this).attr('data-id'),\n");
      out.write("                        evento_id:");
      out.print(e_evento_id);
      out.write("},\n");
