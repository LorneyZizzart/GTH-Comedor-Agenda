...
public final class evento_005fevento_005fruleta_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (sesionmenu.getAttribute("USUARIO") == null) {
      ...
      out.write('\n');
      Controlador.Evento_ActividadController consultaEventoActividad = null;
      synchronized (_jspx_page_context) {
        consultaEventoActividad = (Controlador.Evento_ActividadController) _jspx_page_context.getAttribute("consultaEventoActividad", PageContext.PAGE_SCOPE);
        if (consultaEventoActividad == null){
          consultaEventoActividad = new Controlador.Evento_ActividadController();
          _jspx_page_context.setAttribute("consultaEventoActividad", consultaEventoActividad, PageContext.PAGE_SCOPE);
        }
      }
      out.write('\n');
      out.write('\n');
    ...
    int cantidad_actividad = consultaEventoActividad.Cantidad_ActividadesEvento(e_evento_id);
      ...
      out.write("                                Buscar actividades participadas\n");
      out.write("                            </div>\n");
      out.write("                            <div class=\"col-xs-4\">\n");
      out.write("                                <select class=\"form-control\" id=\"cantidad_participa\" name=\"cantidad_participa\">\n");
 ...
 for (int i = 1; i <= cantidad_actividad; i++) {
      ...
      out.write("                                <button type=\"button\" class=\"btn_buscar_cantidad btn btn-primary pull-left\">Buscar</button>\n");
      out.write("                            </div>\n");
      out.write("                        </div>\n");
      out.write("                        <div class=\"row\">\n");
      out.write("                            <div class=\"col-md-12 ver_ruleta\"></div>\n");
      out.write("                        </div>\n");
      out.write("                    </div>\n");
      out.write("\n");
      out.write("\n");
      ...
      out.write("\n");
      out.write("\n");
      out.write("        $('.btn_buscar_cantidad').click(function () {\n");
      out.write("            var evento = ");
      out.print(e_evento_id);
      out.write(";\n");
      out.write("            var cantidad = $('#cantidad_participa').val();\n");
      out.write("\n");
      out.write("            $(\".ver_ruleta\").html(\"\");\n");
      out.write("            $(\".ver_ruleta\").addClass('loader');\n");
      out.write("            $.post('evento_evento_ruleta_busca.jsp',\n");
      out.write("                    {cantidad: cantidad,\n");
      out.write("                        evento_id: evento},\n");
      out.write("                    function (html) {\n");
      out.write("                        $(\".ver_ruleta\").removeClass('loader');\n");
      out.write("                        $(\".ver_ruleta\").html(html);\n");
      out.write("                    }\n");
      out.write("            ).fail(function (jqXHR, textStatus, errorThrown)\n");
      out.write("            {\n");
      out.write("                var alerta = \"<p class='bg-danger'>error: \" + errorThrown + \"</p>\";\n");
      out.write("                $(\".ver_ruleta\").removeClass('loader');\n");
      out.write("                $(\".ver_ruleta\").html(alerta);\n");
      out.write("            });\n");
      out.write("\n");
      out.write("        });\n");
      out.write("\n");
