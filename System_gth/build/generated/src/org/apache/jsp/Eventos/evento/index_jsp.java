...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    eventos = consultaEvento.GetAllEventoActivo();
      ...
      out.write("                    <h3 class=\"box-title\">Eventos Vigentes</h3>\n");
      out.write("                    <button id=\"formNuevoArea\" type=\"button\" class=\"btn-purple btn-right_nivel\" data-toggle=\"modal tooltip\" data-target=\"#modal-default\" data-placement=\"bottom\" title=\"Añadir Evento\">\n");
      ...
      out.write("                            <tr>\n");
      out.write("                                <th>#</th>\n");
      out.write("                                <th>Nombre Eventos</th>\n");
      ...
      out.write("</td>\n");
      out.write("                                <td>");
      out.print(e.getNombre_evento());
      out.write("</td>\n");
      out.write("                                <td>");
      out.print(e.getFecha_inicio());
      out.write("</td>\n");
      out.write("                                <td>");
      out.print(e.getFecha_fin());
      out.write("</td>\n");
      out.write("                                <td>");
      out.print(e.getDetalle());
      out.write("</td>\n");
      out.write("                                <td style=\"width: 200px\">\n");
      out.write("                                    <div class=\"btn-group \">\n");
      out.write("                                        <a href=\"persona_lista.jsp?iddsesasdasdf=");
      out.print(_encript.ValorAEncriptar(Integer.toString(e.getEvento_id())));
      out.write("\" class=\"btn btn-xs btn-primary edit_button\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Participantes\"><i class=\"fa fa-users\"></i></a>                            \n");
      out.write("                                        <a href=\"actividad_lista.jsp?iddsesasdasdf=");
      out.print(_encript.ValorAEncriptar(Integer.toString(e.getEvento_id())));
      out.write("\" class=\"btn btn-xs btn-success edit_button\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Actividades\"><i class=\"fa fa-calendar-check-o\"></i></a>\n");
      out.write("                                        <a href=\"evento_genera_qr_personal.jsp?iddsesasdasdf=");
      out.print(_encript.ValorAEncriptar(Integer.toString(e.getEvento_id())));
      out.write("\" class=\"btn btn-xs btn-default\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Genera QR\"><i class=\"fa fa-qrcode\"></i></a>\n");
      out.write("                                        <a href=\"evento_evento_ruleta.jsp?iddsesasdasdf=");
      out.print(e.getEvento_id());
      ...
      out.write("                                        <a data-id=\"");
      out.print(_encript.ValorAEncriptar(Integer.toString(e.getEvento_id())));
      out.write("\" class=\"event_edita btn btn-xs btn-info edit_button\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Editar\"><i class=\"fa fa-edit\"></i></a>                            \n");
      out.write("                                        <a data-id=\"");
      out.print(_encript.ValorAEncriptar(Integer.toString(e.getEvento_id())));
      out.write("\" class=\"event_desac btn btn-xs btn-warning edit_button\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Desactivar\"><i class=\"fa fa-circle-o\"></i></a>\n");
      out.write("                                        <a data-id=\"");
      out.print(_encript.ValorAEncriptar(Integer.toString(e.getEvento_id())));
      out.write("\" class=\"event_elimi btn btn-xs btn-danger delete_button\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Eliminar\"> <i class=\"fa fa-trash-o\"></i></a>                                \n");
      out.write("                                    </div>\n");
      out.write("                                </td>\n");
      out.write("                            </tr>\n");
      out.write("                            ");
      ...
      out.write("\n");
      out.write("<!--Modal-->\n");
      out.write("<div class=\"modal fade\" id=\"registro_area\">\n");
      ...
      out.write("        });\n");
      out.write("\n");
      out.write("        $(\"#formNuevoArea\").click(function (e) {\n");
      out.write("            e.preventDefault();\n");
      out.write("            e.stopImmediatePropagation();\n");
      out.write("            $(\"#titleModal\").html(\"Crear Evento\");\n");
      out.write("            $('#registro_area').modal('show');\n");
      out.write("            $(\".cuerpo_registro\").html('');\n");
      out.write("            $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("            //$.post('lista_cuenta_duplicada.jsp',\n");
      out.write("            $.post('crear_evento.jsp?evento_id=1',\n");
      ...
      out.write("        });\n");
      out.write("\n");
      out.write("        $(\".event_edita\").click(function (e) {\n");
      out.write("            e.preventDefault();\n");
      out.write("            e.stopImmediatePropagation();\n");
      out.write("            $(\"#titleModal\").html(\"Editar Evento\");\n");
      out.write("            $('#registro_area').modal('show');\n");
      out.write("            $(\".cuerpo_registro\").html('');\n");
      out.write("            $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("            //$.post('lista_cuenta_duplicada.jsp',\n");
      out.write("            $.post('crear_evento.jsp',\n");
      out.write("                    {evento_id: $(this).attr('data-id')},\n");
      out.write("                    function (html) {\n");
      out.write("                        $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                        $(\".cuerpo_registro\").html(html);\n");
      out.write("                    }\n");
      ...
      out.write("        });\n");
      out.write("\n");
      out.write("        $(\".event_desac\").click(function (e) {\n");
      out.write("            e.preventDefault();\n");
      out.write("            e.stopImmediatePropagation();\n");
      out.write("            $(\"#titleModal\").html(\"Desactivar Evento\");\n");
      out.write("            $('#registro_area').modal('show');\n");
      out.write("            $(\".cuerpo_registro\").html('');\n");
      out.write("            $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("            //$.post('lista_cuenta_duplicada.jsp',\n");
      out.write("            $.post('desactivar_evento.jsp',\n");
      out.write("                    {evento_id: $(this).attr('data-id')},\n");
      out.write("                    function (html) {\n");
      out.write("                        $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                        $(\".cuerpo_registro\").html(html);\n");
      ...
      out.write("        });\n");
      out.write("\n");
      out.write("        $(\".event_elimi\").click(function (e) {\n");
      out.write("            e.preventDefault();\n");
      out.write("            e.stopImmediatePropagation();\n");
      out.write("            $(\"#titleModal\").html(\"Elimina Evento\");\n");
      out.write("            $('#registro_area').modal('show');\n");
      out.write("            $(\".cuerpo_registro\").html('');\n");
      out.write("            $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("            //$.post('lista_cuenta_duplicada.jsp',\n");
      out.write("            $.post('elimina_evento.jsp',\n");
      out.write("                    {evento_id: $(this).attr('data-id')},\n");
      out.write("                    function (html) {\n");
      out.write("                        $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                        $(\".cuerpo_registro\").html(html);\n");
