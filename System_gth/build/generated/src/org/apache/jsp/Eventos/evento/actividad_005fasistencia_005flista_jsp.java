...
public final class actividad_005fasistencia_005flista_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    Empleados = consultaActividad.EmpleadosNoregistradoActividad(actividad.getEvento_Actividad_id(), e_evento_id);
      ...
      out.write("        <li><a href=\"actividad_lista.jsp?iddsesasdasdf=");
      out.print(e_cod_id);
      out.write("\"><i class=\"fa fa-dashboard\"></i> Actividades</a></li>\n");
      out.write("    </ol>\n");
      out.write("</section>\n");
      out.write("\n");
      ...
      out.write("                    <h3 class=\"box-title\">Lista de Participante no registrados</h3>\n");
      ...
      out.write("\">\n");
      out.write("\n");
      out.write("                                    <td><button type=\"button\" data-id=\"");
      out.print(em.getEmpleado_id());
      out.write("\" class=\"btn btn-default registra_asistencia\">Asistencia</button></td>\n");
      out.write("                                    <td>");
      out.print(contador);
      out.write("</td>\n");
      out.write("                                    <td>");
      ...
      out.write("        });\n");
      out.write("\n");
      out.write("        $('.registra_asistencia').click(function () {\n");
      out.write("            var emple_id = $(this).attr('data-id');\n");
      out.write("\n");
      out.write("            $.post('actividad_asistencia_registra.jsp',\n");
      out.write("                    {id_evento: ");
      out.print(e_evento_id);
      out.write(",\n");
      out.write("                        id_actividad: ");
      out.print(e_acti_id);
      out.write(",\n");
      out.write("                        id_empleado: $(this).attr('data-id')},\n");
      out.write("                    function (html) {\n");
