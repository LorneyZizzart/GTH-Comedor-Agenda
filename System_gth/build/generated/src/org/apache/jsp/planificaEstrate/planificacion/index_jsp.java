...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    plan_objetivos = verPlanObjetivos.GetAllPlanObjetivobyUser(empleado_id);
      ...
      out.write("                    <h3 class=\"box-title\">Lista de Objetivos</h3>\n");
      out.write("                    <a href=\"#\" class=\"btn-purple btn-right_nivel planificacion_crear\" data-toggle=\"tooltip\" title=\"Añadir planificación\"><i class=\"fa fa-plus\"></i></a>   \n");
      out.write("                </div>\n");
      ...
      out.write("                    <table id=\"example\" class=\"table table-bordered cell-border\">\n");
      out.write("                        <thead>\n");
      out.write("                            <tr>\n");
      out.write("                                <th></th>\n");
      out.write("                                <th>#</th>\n");
      ...
      out.write("                                <td class=\"details-control\" data-id=\"");
      out.print(id);
      out.write("\" ></td>\n");
      out.write("                                <td>");
      out.print(contador);
      ...
      out.write("</td>\n");
      out.write("                                <td>\n");
      out.write("                                    <a href=\"objetivo_ver.jsp?id=");
      out.print(id);
      ...
      out.write("                                    <a data-id=\"");
      out.print(id);
      out.write("\" class=\"plan_edita btn btn-xs btn-info edit_button\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Editar\"><i class=\"fa fa-edit\"></i></a>\n");
      out.write("                                    <a data-id=\"");
      out.print(id);
      out.write("\" class=\"plan_elimi btn btn-xs btn-danger delete_button\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Eliminar\"> <i class=\"fa fa-trash-o\"></i></a>                                                                    \n");
      out.write("                                </td>\n");
      out.write("                            </tr>\n");
      out.write("                            ");
      ...
      out.write("</html>\n");
      out.write(" \n");
      out.write("<script type=\"text/javascript\" language=\"javascript\" class=\"init\">\n");
      out.write("    function format(d, b) {\n");
      out.write("\n");
      out.write("        var fila = $('<div/>')\n");
      out.write("                .addClass('loader')\n");
      out.write("                .text(' Cargando ... ');\n");
      out.write("        $.post('objetivo_ver_.jsp',\n");
      out.write("                {id: b},\n");
      out.write("                function (html) {\n");
      ...
      out.write("            } else {\n");
      out.write("                row.child(format(row.data(), id)).show();\n");
      out.write("                tr.addClass('shown');\n");
      out.write("            }\n");
      out.write("        });\n");
      out.write("\n");
      out.write("        $(\".planificacion_crear\").click(function (e) {\n");
      out.write("            e.preventDefault();\n");
      out.write("            e.stopImmediatePropagation();\n");
      out.write("            $(\"#titleModal\").html(\"Crear Objetivo\");\n");
      ...
      out.write("        });\n");
      out.write("\n");
      out.write("        $(\".plan_edita\").click(function (e) {\n");
      out.write("            e.preventDefault();\n");
      out.write("            e.stopImmediatePropagation();\n");
      out.write("            $(\"#titleModal\").html(\"Editar Planificación\");\n");
      out.write("            $('#crear_planificacion').modal('show');\n");
      out.write("            $(\".cuerpo_registro\").html('');\n");
      out.write("            $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("            //$.post('lista_cuenta_duplicada.jsp',\n");
      ...
      out.write("        });\n");
      out.write("\n");
      out.write("        $(\".plan_elimi\").click(function (e) {\n");
      out.write("            e.preventDefault();\n");
      out.write("            e.stopImmediatePropagation();\n");
      out.write("            $(\"#titleModal\").html(\"Elimina Planificación\");\n");
      out.write("            $('#crear_planificacion').modal('show');\n");
      out.write("            $(\".cuerpo_registro\").html('');\n");
      out.write("            $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("            //$.post('lista_cuenta_duplicada.jsp',\n");
      out.write("            $.post('plan_nuevo_elimina.jsp',\n");
      out.write("                    {id: $(this).attr('data-id')},\n");
      out.write("                    function (html) {\n");
      out.write("                        $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                        $(\".cuerpo_registro\").html(html);\n");
