...
public final class matriz_005fnuevo_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (matriz != null) {
      ...
      out.write("                        <input type=\"text\" class=\"form-control\" id=\"Plan_matriz_id\" name=\"Plan_matriz_id\" value=\"");
...
if (matriz != null) {
      ...
      out.write("                                            <textarea class=\"matriz_como_ form-control\" style=\"width: 100%\" id=\"mat_como\" name=\"mat_como\" placeholder=\"Como\">");
if (matriz != null) {
...
if (matriz != null) {
      ...
      out.write("                                        </div>   \n");
      out.write("                                        <div class=\"box-footer\">                                            \n");
      out.write("                                            <button type=\"button\" class=\"btn btn-purple pull-right btn-guarda-comohacer\">Guardar Como hacer</button>\n");
      out.write("                                        </div>\n");
      out.write("                                    </div>\n");
      out.write("                                </div>\n");
      out.write("                            </div>\n");
...
if (matriz != null) {
      ...
      out.write("\">\n");
      out.write("\n");
      out.write("                                            <button type=\"button\" class=\"btn btn-purple pull-right btn-guarda-indicador\">Guardar Indicador</button>\n");
      out.write("\n");
      out.write("                                        </div>\n");
      out.write("                                    </div>\n");
      out.write("                                </div>\n");
      ...
      out.write("        });\n");
      out.write("\n");
      out.write("        $(\".btn-guarda-qhacer\").click(function (e) {\n");
      out.write("            e.stopImmediatePropagation();\n");
      out.write("            var que_hacer_ = $('#mat_quehacer').val();\n");
      out.write("            if (1 > que_hacer_.length) {\n");
      out.write("                toastr.error(\"Se requiere campo: Que Hacer\");\n");
      out.write("                return false;\n");
      out.write("            }\n");
      out.write("            var que_hacer_res = $('#mat_responsable').val();\n");
      out.write("            if (1 > que_hacer_res.length) {\n");
      out.write("                toastr.error(\"Se requiere Responsable\");\n");
      out.write("                return false;\n");
      out.write("            }\n");
      out.write("            var dataString = $('#form_plan_accion_nuevo').serialize();\n");
      out.write("            //var $form = $(e.target);\n");
      out.write("            $.ajax({\n");
      out.write("                type: \"POST\",\n");
      out.write("                url: \"../plan_accion/matriz_nuevo_guardar.jsp\",\n");
      ...
      out.write("                {\n");
      out.write("                    $(\".mensaje\").removeClass(\"loader\");\n");
      out.write("                    toastr.success(data);\n");
      out.write("\n");
      out.write("                }, error: function (XMLHttpRequest, textStatus, errorThrown) {\n");
      out.write("                    $(\".mensaje\").removeClass(\"loader\");\n");
      out.write("                    var menn = \"Se produjo un error \" + errorThrown + \"  \" + textStatus;\n");
      out.write("                    //$(\".mensaje\").html(menn);\n");
      out.write("                    toastr.error(menn);\n");
      out.write("                }\n");
      out.write("            });\n");
      out.write("        });\n");
      out.write("\n");
      out.write("        $(\".btn-guarda-comohacer\").click(function (e) {\n");
      out.write("            e.stopImmediatePropagation();\n");
      out.write("            var como_hacer_ = $('#mat_como').val();\n");
      out.write("            if (1 > como_hacer_.length) {\n");
      out.write("                toastr.error(\"Se requiere campo: Como Hacer\");\n");
      out.write("                return false;\n");
      out.write("            }\n");
      out.write("            var mat_documento = $('#mat_documento').val();\n");
      out.write("            if (1 > mat_documento.length) {\n");
      out.write("                toastr.error(\"Se requiere campo: Documento generado\");\n");
      out.write("                return false;\n");
      out.write("            }\n");
      out.write("            var dataString = $('#form_plan_accion_nuevo').serialize();\n");
      out.write("            //var $form = $(e.target);\n");
      ...
      out.write("        });\n");
      out.write("\n");
      out.write("        $(\".btn-guarda-indicador\").click(function (e) {\n");
      out.write("            e.stopImmediatePropagation();\n");
      out.write("            var como_hacer_ = $('#mat_indicador_nombre').val();\n");
      out.write("            if (1 > como_hacer_.length) {\n");
      out.write("                toastr.error(\"Se requiere campo: Nombre\");\n");
      out.write("                return false;\n");
      out.write("            }\n");
      out.write("            var mat_documento = $('#mat_fecha').val();\n");
      out.write("            if (1 > mat_documento.length) {\n");
      out.write("                toastr.error(\"Se requiere campo: Fecha\");\n");
      out.write("                return false;\n");
      out.write("            }\n");
      out.write("\n");
      out.write("            var mat_indicador = $('#mat_indicador').val();\n");
      out.write("            if (1 > mat_documento.length) {\n");
      out.write("                toastr.error(\"Se requiere campo: Indicador\");\n");
      out.write("                return false;\n");
      out.write("            }\n");
      out.write("            var dataString = $('#form_plan_accion_nuevo').serialize();\n");
      out.write("            //var $form = $(e.target);\n");
