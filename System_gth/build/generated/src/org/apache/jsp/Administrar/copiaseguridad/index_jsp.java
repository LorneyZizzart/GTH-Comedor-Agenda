package org.apache.jsp.Administrar.copiaseguridad;
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/Administrar/copiaseguridad/../../masterPage/complemento/head.jsp");
    _jspx_dependants.add("/Administrar/copiaseguridad/../../masterPage/complemento/menu.jsp");
    _jspx_dependants.add("/Administrar/copiaseguridad/../../masterPage/complemento/footer.jsp");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (sesionmenu.getAttribute("USUARIO") == null) {
      ...
      out.write("        <small> Copia de Seguridad db</small>\n");
      out.write("    </h1>\n");
      ...
      out.write("                    <h4 class=\"modal-title\">Generar copia de seguridad</h4>\n");
      out.write("                </div>\n");
      out.write("                <div class=\"modal-body\">\n");
      out.write("                    <p>Se generara una copia de seguridad en el servidor donde se encuentra alojado el sistema.</p>\n");
      out.write("                </div>\n");
      out.write("                <div class=\"modal-footer\">\n");
      out.write("                    <button type=\"button\" class=\"btn btn-default pull-left btn_cancelar\">Cancelar</button>\n");
      out.write("                    <button type=\"button\" class=\"btn-purple btn_generar\">Generar Copia</button>\n");
      out.write("                </div>\n");
      ...
      out.write("        $(\".btn_generar\").click(function (e) {\n");
      out.write("            e.preventDefault();\n");
      out.write("            e.stopImmediatePropagation();\n");
      out.write("            $(\"#mensaje\").html(\"\");\n");
      out.write("            $(\"#mensaje\").addClass(\"loader\");\n");
      out.write("            $.post('guardar_copia.jsp',\n");
      out.write("                    {},\n");
      out.write("                    function (html, textStatus, jqXHR) {\n");
      out.write("                        $(\"#mensaje\").removeClass('loader');\n");
      out.write("                        $(\"#mensaje\").html(html);\n");
      out.write("                    }).fail(function (jqXHR, textStatus, errorThrown)\n");
      out.write("            {\n");
      out.write("                $(\"#mensaje\").removeClass('loader');\n");
      out.write("                $(\"#mensaje\").html(errorThrown);\n");
      out.write("            });\n");
      out.write("        });\n");
      out.write("        \n");
      out.write("        $(\".btn_cancelar\").click(function (e) {\n");
      out.write("            e.preventDefault();\n");
      out.write("            e.stopImmediatePropagation();\n");
