...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/Administrar/opcion/../../masterPage/complemento/head.jsp");
    _jspx_dependants.add("/Administrar/opcion/../../masterPage/complemento/menu.jsp");
    _jspx_dependants.add("/Administrar/opcion/../../masterPage/complemento/footer.jsp");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (sesionmenu.getAttribute("USUARIO") == null) {
      ...
      out.write('\n');
      Controlador.OpcionController consultaOpcion = null;
      synchronized (_jspx_page_context) {
        consultaOpcion = (Controlador.OpcionController) _jspx_page_context.getAttribute("consultaOpcion", PageContext.PAGE_SCOPE);
        if (consultaOpcion == null){
          consultaOpcion = new Controlador.OpcionController();
          _jspx_page_context.setAttribute("consultaOpcion", consultaOpcion, PageContext.PAGE_SCOPE);
        }
      }
      out.write('\n');
    ...
    ListaOpcion = consultaOpcion.GetAllOpciones();
      ...
      out.write("                    <h3 class=\"box-title\">Lista de Opciones</h3> \n");
      out.write("                    <button id=\"formNuevo\" type=\"button\" class=\"btn-purple btn-right_nivel\" data-toggle=\"modal\" data-target=\"#modal-default\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Añadir opción\">\n");
      ...
      out.write("</td>\n");
      out.write("                                <td>");
      out.print(item.getDescriocion());
      out.write(" </td>\n");
      out.write("                                <td>");
      out.print(_character.CharacterUCFirst(item.getNombre_menu()));
      out.write(" </td>\n");
      out.write("                                <td>");
 if (item.getEstado() == 1) {
      ...
      out.write("                                <a data-id=\"");
      out.print(item.getOpcion_id());
      out.write("\" class=\"formDelete btn btn-danger btn-xs delete_button\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Eliminar\"> <i class=\"fa fa-trash-o\"></i></a>                                \n");
      out.write("                            </div></td>\n");
      out.write("                        </tr>\n");
      out.write("                        ");
      ...
      out.write("        $(\"#titleModal\").html(\"Crear Opción\");\n");
      ...
      out.write("            $.post('crearOpcion.jsp',\n");
      ...
      out.write("        $(\"#titleModal\").html(\"Editar Opción\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("        \n");
      out.write("        $('#formulario_registro').modal('show');\n");
      ...
      out.write("        $(\"#titleModal\").html(\"Eliminar Opción\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("        \n");
      out.write("        $('#formulario_registro').modal('show');\n");
      ...
      out.write("        $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("        \n");
      out.write("        $.post('eliminaopcion.jsp',\n");
      out.write("            {id: $(this).attr('data-id')},\n");
      out.write("                    function (html) {\n");
      out.write("                    $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                    $(\".cuerpo_registro\").html(html);\n");
