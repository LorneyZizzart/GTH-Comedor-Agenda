...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/Administrar/accesousuarios/../../masterPage/complemento/head.jsp");
    _jspx_dependants.add("/Administrar/accesousuarios/../../masterPage/complemento/menu.jsp");
    _jspx_dependants.add("/Administrar/accesousuarios/../../masterPage/complemento/footer.jsp");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    Usuarios = consultaUser.GetAllUser();
      ...
      out.write("        <small>Acceso de Usuarios</small>\n");
      out.write("    </h1>\n");
      out.write("    <ol class=\"breadcrumb\">\n");
      out.write("        <li><a href=\"#\"><i class=\"fa fa-dashboard\"></i> Inicio</a></li>\n");
      out.write("        <li class=\"active\">Panel</li>\n");
      out.write("    </ol>\n");
      out.write("</section>\n");
      out.write("\n");
      ...
      out.write("                    <h3 class=\"box-title\">Lista de Usuarios</h3>\n");
      out.write("                    <button id=\"formNuevo\" type=\"button\" class=\"btn-purple btn-right_nivel\" data-toggle=\"modal\" data-target=\"#modal-default\" title=\"Añadir usuario\">\n");
      ...
      out.write("</td>\n");
      out.write("                                <td>");
      out.print(_character.CharacterUCFirst(item.getPerfil()));
      out.write("</td>\n");
      out.write("                                <td>");
 if (item.getEstado() == 1) {
      ...
      out.write(" </td>\n");
      out.write("                                <td class=\"text-center\" ><div class=\"btn-group\">\n");
      out.write("                                        <a data-id=\"");
      out.print(_encript.ValorAEncriptar(Integer.toString(item.getUser_id())));
      out.write("\" class=\"formAcceso title btn btn-xs btn-success\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Accesos\"><i class=\"fa fa-list-ol\"></i></a>\n");
      out.write("                                        <a data-id=\"");
      out.print(_encript.ValorAEncriptar(Integer.toString(item.getUser_id())));
      out.write("\" class=\"formUser title btn btn-xs btn-info edit_button\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Editar usuario\"><i class=\"fa fa-user\"></i></a>                                         \n");
      out.write("                                        <a data-id=\"");
      out.print(_encript.ValorAEncriptar(Integer.toString(item.getUser_id())));
      out.write("\" class=\"formPassword title btn btn-xs btn-primary edit_button\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Editar contraseña\"><i class=\"fa fa-unlock-alt\"></i></a>  \n");
      out.write("                                        <a data-id=\"");
      out.print(_encript.ValorAEncriptar(Integer.toString(item.getUser_id())));
      out.write("\" class=\"formDelete title btn btn-danger btn-xs delete_button\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Eliminar\"> <i class=\"fa fa-trash-o\"></i></a>                                \n");
      out.write("                                </div></td>\n");
      out.write("                            </tr>\n");
      out.write("                            ");
      ...
      out.write("        $(\"#titleModal\").html(\"Crear Usuario\");\n");
      ...
      out.write("            $.post('crearUsuario.jsp',\n");
      ...
      out.write("            });\n");
      out.write("    });\n");
      out.write("    $(\".formUser\").click(function (e) {\n");
      out.write("        $(\"#titleModal\").html(\"Editar Usuario\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("            $('#formulario_registro').modal('show');\n");
      out.write("            $(\".cuerpo_registro\").html('');\n");
      out.write("            $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("            $.post('editUsuario.jsp',\n");
      out.write("            {id: $(this).attr('data-id')},\n");
      out.write("                    function (html) {\n");
      out.write("                    $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                    $(\".cuerpo_registro\").html(html);\n");
      ...
      out.write("            });\n");
      out.write("    });\n");
      out.write("    $(\".formPassword\").click(function (e) {\n");
      out.write("        $(\"#titleModal\").html(\"Editar Contraseña\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("            $('#formulario_registro').modal('show');\n");
      out.write("            $(\".cuerpo_registro\").html('');\n");
      out.write("            $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("            $.post('editPassword.jsp',\n");
      out.write("            {id: $(this).attr('data-id')},\n");
      out.write("                    function (html) {\n");
      out.write("                    $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                    $(\".cuerpo_registro\").html(html);\n");
      ...
      out.write("            });\n");
      out.write("    });\n");
      out.write("    $(\".formDelete\").click(function (e) {\n");
      out.write("        $(\"#titleModal\").html(\"Eliminar Usuario\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("            $('#formulario_registro').modal('show');\n");
      out.write("            $(\".cuerpo_registro\").html('');\n");
      out.write("            $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("            $.post('eliminarUsuario.jsp',\n");
      out.write("            {id: $(this).attr('data-id')},\n");
      out.write("                    function (html) {\n");
      out.write("                    $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                    $(\".cuerpo_registro\").html(html);\n");
      ...
      out.write("    });\n");
      out.write("    \n");
      out.write("    $(\".formAcceso\").click(function (e) {\n");
      out.write("        $(\"#titleModal\").html(\"Permisos\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("            $('#formulario_registro').modal('show');\n");
      out.write("            $(\".cuerpo_registro\").html('');\n");
      out.write("            $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("            $.post('editAcceso.jsp',\n");
      out.write("            {id: $(this).attr('data-id')},\n");
      out.write("                    function (html) {\n");
      out.write("                    $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                    $(\".cuerpo_registro\").html(html);\n");
