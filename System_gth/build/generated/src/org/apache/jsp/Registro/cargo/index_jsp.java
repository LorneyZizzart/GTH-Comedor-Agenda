...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/Registro/cargo/../../masterPage/complemento/head.jsp");
    _jspx_dependants.add("/Registro/cargo/../../masterPage/complemento/menu.jsp");
    _jspx_dependants.add("/Registro/cargo/../../masterPage/complemento/footer.jsp");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    cargos = _cargo.getAllCargoByCargoId();
      ...
      out.write("                    <h3 class=\"box-title\">Lista de Cargos</h3>\n");
      out.write("                    <button id=\"formNuevo\" type=\"button\" class=\"btn-purple btn-right_nivel\" data-toggle=\"modal tooltip\" data-target=\"#modal-default\" data-placement=\"bottom\" title=\"Añadir cargo\">\n");
 ...
 if (item.getEstado() == 1) {
      ...
      out.write("                                <a data-id=\"");
      out.print(_encript.ValorAEncriptar(Integer.toString(item.getCargo_id())));
      out.write("\" class=\"formEdit btn btn-xs btn-primary edit_button\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Editar cargo\"><i class=\"fa fa-edit\"></i></a>                                \n");
      out.write("                                <a data-id=\"");
      out.print(_encript.ValorAEncriptar(Integer.toString(item.getCargo_id())));
      out.write("\" class=\"formEliminar btn btn-danger btn-xs delete_button\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Eliminar cargo\"> <i class=\"fa fa-trash-o\"></i></a>                                \n");
      out.write("                            </div>\n");
      out.write("                        </td>\n");
      out.write("                        </tr>\n");
      out.write("                        ");
      ...
      out.write("        $(\"#titleModal\").html(\"Crear cargo\");\n");
      ...
      out.write("        $(\"#titleModal\").html(\"Editar cargo\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("\n");
      out.write("        $('#formulario_registro').modal('show');\n");
      ...
      out.write("        $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("\n");
      out.write("        $.post('editarCargo.jsp',\n");
      out.write("                {id: $(this).attr('data-id')},\n");
      out.write("        function (html) {\n");
      out.write("            $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("            $(\".cuerpo_registro\").html(html);\n");
      ...
      out.write("        $(\"#titleModal\").html(\"Eliminar cargo\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("\n");
      out.write("        $('#formulario_registro').modal('show');\n");
      ...
      out.write("        $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("\n");
      out.write("        $.post('eliminarCargo.jsp',\n");
      out.write("                {id: $(this).attr('data-id')},\n");
      out.write("        function (html) {\n");
      out.write("            $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("            $(\".cuerpo_registro\").html(html);\n");
