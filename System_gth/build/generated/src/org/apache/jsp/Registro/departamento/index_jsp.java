...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/Registro/departamento/../../masterPage/complemento/head.jsp");
    _jspx_dependants.add("/Registro/departamento/../../masterPage/complemento/menu.jsp");
    _jspx_dependants.add("/Registro/departamento/../../masterPage/complemento/footer.jsp");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    ListaDepartamento = _departamento.GetAllDepartamento();
      ...
      out.write("    <h1>\n");
      out.write("        Registro\n");
      out.write("        <small> de Departamentos</small>\n");
      out.write("    </h1>\n");
      ...
      out.write("                    <h3 class=\"box-title\">Lista de Departamentos</h3>\n");
      out.write("                    <button id=\"formNuevo\" type=\"button\" class=\"btn-purple btn-right_nivel\" data-toggle=\"modal tooltip\" data-target=\"#modal-default\" data-placement=\"bottom\" title=\"Añadir nivel\">\n");
      ...
      out.write("</td>\n");
      out.write("                                <td>");
      out.print(item.getArea_Nombre());
      out.write("</td>\n");
      out.write("                                \n");
      out.write("                                <td>");
 if(!item.getDepartamento_Nombre_dep().equals("0")){
 ...
 if (item.getEstado() == 1) {
      ...
      out.write("                                        <a data-id=\"");
      out.print(_encript.ValorAEncriptar(Integer.toString(item.getDepartamento_id())));
      ...
      out.write("        $(\"#titleModal\").html(\"Editar Departamento\");\n");
      ...
      out.write("        \n");
      out.write("        $.post('editarDepartamento.jsp',\n");
      ...
      out.write("        $(\"#titleModal\").html(\"Eliminar Departamento\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("        \n");
      out.write("        $('#formulario_registro').modal('show');\n");
      ...
      out.write("        $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("        \n");
      out.write("        $.post('eliminarDepartamento.jsp',\n");
      out.write("            {id: $(this).attr('data-id')},\n");
      out.write("                    function (html) {\n");
      out.write("                    $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                    $(\".cuerpo_registro\").html(html);\n");
      ...
      out.write("        $(\"#titleModal\").html(\"Crear Departamento\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("            $('#formulario_registro').modal('show');\n");
      out.write("            $(\".cuerpo_registro\").html('');\n");
      ...
      out.write("            $.post('crearDepartamento.jsp',\n");
      out.write("            {id: $(this).attr('data-id')},\n");
      out.write("                    function (html) {\n");
      out.write("                    $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                    $(\".cuerpo_registro\").html(html);\n");
