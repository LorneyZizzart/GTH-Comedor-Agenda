...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/Registro/cliente/../../masterPage/complemento/head.jsp");
    _jspx_dependants.add("/Registro/cliente/../../masterPage/complemento/menu.jsp");
    _jspx_dependants.add("/Registro/cliente/../../masterPage/complemento/footer.jsp");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    listaCliente = _cliente.getAllClientes();

      out.write("\n");
      out.write("<section class=\"content-header\">\n");
      out.write("    <h1>\n");
      out.write("        Registro\n");
      out.write("        <small> de Clientes</small>\n");
      out.write("    </h1>\n");
      ...
      out.write("                    <h3 class=\"box-title\">Lista de Clientes</h3>\n");
      out.write("                    <button id=\"formNuevo\" type=\"button\" class=\"btn-purple btn-right_nivel\" data-toggle=\"modal\" data-target=\"#modal-default\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Añadir cliente\">\n");
 ...
 if (item.getEstado() == 1) {
      ...
      out.write("                                        <a data-id=\"");
      out.print(_encript.ValorAEncriptar(Integer.toString(item.getCliente_id())));
      ...
      out.write("        $(\"#titleModal\").html(\"Añadir cliente\");\n");
      ...
      out.write("            $.post('crearCliente.jsp',\n");
      ...
      out.write("        $(\"#titleModal\").html(\"Editar datos del cliente\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("        \n");
      out.write("        $('#formulario_registro').modal('show');\n");
      ...
      out.write("        $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("        \n");
      out.write("        $.post('editarCliente.jsp',\n");
      out.write("            {id: $(this).attr('data-id')},\n");
      out.write("                    function (html) {\n");
      out.write("                    $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                    $(\".cuerpo_registro\").html(html);\n");
      ...
      out.write("        $(\"#titleModal\").html(\"Eliminar cliente\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("        \n");
      out.write("        $('#formulario_registro').modal('show');\n");
      ...
      out.write("        $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("        \n");
      out.write("        $.post('eliminarCliente.jsp',\n");
      out.write("            {id: $(this).attr('data-id')},\n");
      out.write("                    function (html) {\n");
      out.write("                    $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                    $(\".cuerpo_registro\").html(html);\n");
