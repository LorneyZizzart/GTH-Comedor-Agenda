...
public final class foto_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    empleado = _empleado.GetEmpleadoByID(idEmpleado);
      ...
      out.write("\n");
      out.write("\n");
      out.write("<link href=\"./fotografia/statics/main.css\" rel=\"stylesheet\" type=\"text/css\"/>\n");
      out.write("<link href=\"./fotografia/jcrop/jquery.Jcrop.min.css\" rel=\"stylesheet\" type=\"text/css\"/>\n");
      out.write("<script>\n");
      out.write("    var examples = [];\n");
      out.write("</script>\n");
      out.write("\n");
      out.write("<section class=\"content-header\">\n");
      out.write("    <h1>\n");
      out.write("        Registro\n");
      out.write("        <small> de Empleados</small>\n");
      out.write("    </h1>\n");
      out.write("    <ol class=\"breadcrumb\">\n");
      out.write("        <li><a href=\"../../masterPage/complemento/index.jsp\"><i class=\"fa fa-home\"></i> Home</a></li>\n");
      out.write("        <li class=\"active\">Editar Fotografia</li>\n");
      out.write("    </ol>\n");
      out.write("</section>\n");
      ...
      out.write("                    <h3 class=\"box-title\">Editar Fotografia</h3>\n");
      out.write("\n");
      out.write("                </div>\n");
      out.write("\n");
      out.write("\n");
      ...
      out.write("                            <img alt=\"Fotografia Personal\"  style=\"width: 100%; height: auto;  display: block;\" src=\"../../folder_picture/");
      ...
      out.write(' ');
      out.print(empleado.getApellido_paterno());
      out.write(' ');
      out.print(empleado.getApellido_materno());
      out.write("</h3> \n");
      out.write("\n");
      out.write("                            </div> \n");
      out.write("                        </div> \n");
      ...
      out.write("                        <div id=\"userpic\" class=\"userpic\">\n");
      out.write("                            <div class=\"js-preview userpic__preview\"></div>\n");
      out.write("                            <div class=\"btn btn-success js-fileapi-wrapper\">\n");
      out.write("                                <div class=\"js-browse\">\n");
      out.write("                                    <span class=\"btn-txt\">Seleccionar Foto</span>\n");
      out.write("                                    <input type=\"file\" name=\"filedata\"/>\n");
      out.write("                                </div>\n");
      out.write("                                <div class=\"js-upload\" style=\"display: none;\">\n");
      out.write("                                    <div class=\"progress progress-success\"><div class=\"js-progress bar\"></div></div>\n");
      out.write("                                    <span class=\"btn-txt\">Guardar</span>\n");
      out.write("                                </div>\n");
      out.write("                            </div>\n");
      out.write("                        </div>\n");
      out.write("                    </div>\n");
      ...
      out.write("                        <!--Div donde cargara el la imagen para recortar-->\n");
      out.write("                        <div id=\"popup\" class=\"popup\" style=\"display: none;\">\n");
      out.write("                            <div class=\"popup__body\"><div class=\"js-img\"></div></div>\n");
      out.write("                            <div style=\"margin: 0 0 5px; text-align: center;\">\n");
      out.write("                                <div class=\"js-upload btn btn_browse btn_browse_small\">Upload</div>\n");
      out.write("                            </div>\n");
      out.write("                        </div>\n");
      out.write("                    </div>\n");
      out.write("                </div>\n");
      ...
      out.write("\n");
      out.write("<script>\n");
      out.write("    examples.push(function () {\n");
      out.write("        $('#userpic').fileapi({\n");
      out.write("            //url: 'http://192.168.12.110:8080/rep_jas_youtube/subirFoto.jsp',\n");
      out.write("            url: 'subirFoto.jsp?cod_per=");
      out.print(idEmpleado);
      out.write("',\n");
      out.write("            accept: 'image/*',\n");
      out.write("            imageSize: {minWidth: 200, minHeight: 200},\n");
      out.write("            elements: {\n");
      out.write("                active: {show: '.js-upload', hide: '.js-browse'},\n");
      out.write("                preview: {\n");
      out.write("                    el: '.js-preview',\n");
      out.write("                    width: 200,\n");
      out.write("                    height: 200\n");
      out.write("                },\n");
      out.write("                progress: '.js-progress'\n");
      out.write("            },\n");
      out.write("            onSelect: function (evt, ui) {\n");
      out.write("                var file = ui.files[0];\n");
      out.write("\n");
      out.write("                if (!FileAPI.support.transform) {\n");
      out.write("                    alert('Your browser does not support Flash :(');\n");
      out.write("                } else if (file) {\n");
      out.write("                    $('#popup').modal({\n");
      out.write("                        closeOnEsc: true,\n");
      out.write("                        closeOnOverlayClick: false,\n");
      out.write("                        onOpen: function (overlay) {\n");
      out.write("                            $(overlay).on('click', '.js-upload', function () {\n");
      out.write("                                $.modal().close();\n");
      out.write("                                $('#userpic').fileapi('upload');\n");
      out.write("                            });\n");
      out.write("\n");
      out.write("                            $('.js-img', overlay).cropper({\n");
      out.write("                                file: file,\n");
      out.write("                                bgColor: '#fff',\n");
      out.write("                                maxSize: [$(window).width() - 200, $(window).height() - 200],\n");
      out.write("                                minSize: [200, 200],\n");
      out.write("                                selection: '90%',\n");
      out.write("                                onSelect: function (coords) {\n");
      out.write("                                    $('#userpic').fileapi('crop', file, coords);\n");
      out.write("                                }\n");
      out.write("                            });\n");
      out.write("                        }\n");
      out.write("                    }).open();\n");
      ...
      out.write("    });\n");
      out.write("</script>\n");
      out.write("<script src=\"//yandex.st/highlightjs/7.2/highlight.min.js\"></script>\n");
      out.write("<script src=\"//yandex.st/jquery/easing/1.3/jquery.easing.min.js\"></script>\n");
      out.write("\n");
      out.write("\n");
      out.write("<script>\n");
      out.write("    var FileAPI = {\n");
      out.write("        debug: true\n");
      out.write("        , media: true\n");
      out.write("        , staticPath: './FileAPI/'\n");
      out.write("    };\n");
      out.write("</script>\n");
      out.write("<script src=\"./fotografia/FileAPI/FileAPI.min.js\"></script>\n");
      out.write("<script src=\"./fotografia/FileAPI/FileAPI.exif.js\"></script>\n");
      out.write("<script src=\"./fotografia/jquery.fileapi.js\"></script>\n");
      out.write("<script src=\"./fotografia/jcrop/jquery.Jcrop.min.js\"></script>\n");
      out.write("<script src=\"./fotografia/statics/jquery.modal.js\"></script>\n");
      out.write("\n");
      out.write("\n");
      out.write("<script>\n");
      out.write("    jQuery(function ($) {\n");
      out.write("        var $blind = $('.splash__blind');\n");
      out.write("\n");
      out.write("        $('.splash')\n");
      out.write("                .mouseenter(function () {\n");
      out.write("                    $('.splash__blind', this)\n");
      out.write("                            .animate({top: -10}, 'fast', 'easeInQuad')\n");
      out.write("                            .animate({top: 0}, 'slow', 'easeOutBounce')\n");
      out.write("                            ;\n");
      out.write("                })\n");
      out.write("                .click(function () {\n");
      out.write("                    if (!FileAPI.support.media) {\n");
      out.write("                        $blind.animate({top: -$(this).height()}, 'slow', 'easeOutQuart');\n");
      out.write("                    }\n");
      out.write("\n");
      out.write("                    FileAPI.Camera.publish($('.splash__cam'), function (err, cam) {\n");
      out.write("                        if (err) {\n");
      out.write("                            alert(\"Unfortunately, your browser does not support webcam.\");\n");
      out.write("                        } else {\n");
      out.write("                            $('.splash').off();\n");
      out.write("                            $blind.animate({top: -$(this).height()}, 'slow', 'easeOutQuart');\n");
      out.write("                        }\n");
      out.write("                    });\n");
      out.write("                });\n");
      out.write("\n");
      out.write("        function _getCode(node, all) {\n");
      out.write("            var code = FileAPI.filter($(node).prop('innerHTML').split('\\n'), function (str) {\n");
      out.write("                return !!str;\n");
      out.write("            });\n");
      out.write("            if (!all) {\n");
      out.write("                code = code.slice(1, -2);\n");
      out.write("            }\n");
      out.write("\n");
      out.write("            var tabSize = (code[0].match(/^\\t+/) || [''])[0].length;\n");
      out.write("\n");
      out.write("            return $('<div/>')\n");
      out.write("                    .text($.map(code, function (line) {\n");
      out.write("                        return line.substr(tabSize).replace(/\\t/g, '   ');\n");
      out.write("                    }).join('\\n'))\n");
      out.write("                    .prop('innerHTML')\n");
      out.write("                    .replace(/ disabled=\"\"/g, '')\n");
      out.write("                    ;\n");
      out.write("        }\n");
      out.write("\n");
      out.write("\n");
      out.write("// Init examples\n");
      out.write("        FileAPI.each(examples, function (fn) {\n");
      out.write("            fn();\n");
      out.write("        });\n");
      out.write("    });\n");
      out.write("</script>");
