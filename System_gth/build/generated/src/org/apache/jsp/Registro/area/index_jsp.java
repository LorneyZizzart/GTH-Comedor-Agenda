...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/Registro/area/../../masterPage/complemento/head.jsp");
    _jspx_dependants.add("/Registro/area/../../masterPage/complemento/menu.jsp");
    _jspx_dependants.add("/Registro/area/../../masterPage/complemento/footer.jsp");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (sesionmenu.getAttribute("USUARIO") == null) {
      ...
      out.write('\n');
      Controlador.AreaController consultaNivel = null;
      synchronized (_jspx_page_context) {
        consultaNivel = (Controlador.AreaController) _jspx_page_context.getAttribute("consultaNivel", PageContext.PAGE_SCOPE);
        if (consultaNivel == null){
          consultaNivel = new Controlador.AreaController();
    ...
    listaArea = consultaNivel.getAllArea();
      ...
      out.write("    <h1>\n");
      out.write("        Registro\n");
      out.write("        <small> de Areas</small>\n");
      out.write("    </h1>\n");
      ...
      out.write("                    <h3 class=\"box-title\">Lista de Áreas</h3>\n");
      out.write("                    <button id=\"formNuevoArea\" type=\"button\" class=\"btn-purple btn-right_nivel\" data-toggle=\"modal tooltip\" data-target=\"#modal-default\" data-placement=\"bottom\" title=\"Añadir área\">\n");
 ...
 if (item.getEstado() == 1) {
      ...
      out.write("                                        <a data-id=\"");
      out.print(_encript.ValorAEncriptar(Integer.toString(item.getArea_id())));
      out.write("\" class=\"formEditArea btn btn-xs btn-primary edit_button\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Editar\"><i class=\"fa fa-edit\"></i></a>                                \n");
      out.write("                                        <a data-id=\"");
      out.print(_encript.ValorAEncriptar(Integer.toString(item.getArea_id())));
      out.write("\" class=\"formEliminarArea btn btn-danger btn-xs delete_button\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Eliminar\"> <i class=\"fa fa-trash-o\"></i></a>                                \n");
      out.write("                                    </div>\n");
      out.write("                                </td>\n");
      out.write("                            </tr>\n");
      out.write("                            ");
      ...
      out.write(" \n");
      out.write("<script>\n");
      out.write("    $('#formNuevoArea').tooltip({ boundary: 'window' })\n");
      out.write("    $('#example').tooltip({ boundary: 'window' })\n");
      out.write("    function titleModal(e) {\n");
      out.write("       var title;\n");
      out.write("       if (e) title = \"Crear Área\";\n");
      out.write("       else title = \"Editar Área\";\n");
      out.write("       $(\"#titleModal\").html(title);\n");
      out.write("    }\n");
      out.write("        \n");
      out.write("    $(function () {\n");
      ...
      out.write("    });   \n");
      out.write("    \n");
      out.write("    $(\".formEditArea\").click(function (e){\n");
      out.write("        titleModal(false)\n");
      ...
      out.write("    })\n");
      out.write("    \n");
      out.write("    $(\".formEliminarArea\").click(function (e){\n");
      out.write("        $(\"#titleModal\").html(\"Eliminar área\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("        \n");
      out.write("        $('#registro_area').modal('show');\n");
      ...
      out.write("        $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("        \n");
      out.write("        $.post('eliminarArea.jsp',\n");
      out.write("            {id: $(this).attr('data-id')},\n");
      out.write("                    function (html) {\n");
      out.write("                    $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                    $(\".cuerpo_registro\").html(html);\n");
