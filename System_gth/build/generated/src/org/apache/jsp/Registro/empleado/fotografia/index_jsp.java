package org.apache.jsp.Registro.empleado.fotografia;
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/Registro/empleado/fotografia/../../../masterPage/complemento/head.jsp");
    _jspx_dependants.add("/Registro/empleado/fotografia/../../../masterPage/complemento/menu.jsp");
    _jspx_dependants.add("/Registro/empleado/fotografia/../../../masterPage/complemento/footer.jsp");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    listaEmpleado = _empleado.GetAllEmpleado();
      ...
      out.write("        <li class=\"active\">Lista de empleados</li>\n");
      out.write("    </ol>\n");
      out.write("</section>\n");
      ...
      out.write("                    <h3 class=\"box-title\">Lista de Empleados</h3>\n");
      out.write("                    <button id=\"formNuevo\" type=\"button\" class=\"btn-purple btn-right_nivel\" data-toggle=\"modal tooltip\" data-target=\"#modal-default\" data-placement=\"bottom\" title=\"Añadir empleado\">\n");
      ...
      out.write("\n");
      out.write("                            <tr style=\"cursor:pointer;\" class='clickable-row' data-href=\"historialEmpleado.jsp?i=");
      out.print(_encript.ValorAEncriptar(Integer.toString(item.getEmpleado_id())));
      out.write("\">\n");
      out.write("                                <td>");
      out.print(contador);
      out.write("</td>\n");
      out.write("                                <td>");
      out.print(_character.CharacterUCFirst(item.getApellido_paterno()));
      out.write(' ');
      out.print(_character.CharacterUCFirst(item.getApellido_materno()));
      out.write(' ');
 ...
 if (item.getEstado() == 1) {
      ...
      out.write("\n");
      out.write("                        <td>");
      out.print(_character.CharacterUCFirst(item.getCargo().getDepartamento_nombre()));
      out.write("</td>\n");
      out.write("                        <td>");
      out.print(_character.CharacterUCFirst(item.getCargo().getCargo_nombre()));
      out.write("</td>\n");
      out.write("                        <td>");
      out.print(_character.CharacterUCFirst(item.getCargo().getNivel_nombre()));
      out.write("</td>\n");
      out.write("                        ");
      ...
      out.write("                                <a href=\"historialEmpleado.jsp?i=");
      out.print(_encript.ValorAEncriptar(Integer.toString(item.getEmpleado_id())));
      out.write("\" class=\"formHistorial btn btn-xs btn-info\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Ver historial\"><i class=\"fa fa-eye\"></i></a> \n");
      out.write("                                <a data-id=\"");
      out.print(_encript.ValorAEncriptar(Integer.toString(item.getEmpleado_id())));
      out.write("\" class=\"formCargo btn btn-xs btn-success\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Cargo\"><i class=\"fa fa-wrench\"></i></a> \n");
      out.write("                                <a data-id=\"");
      out.print(_encript.ValorAEncriptar(Integer.toString(item.getEmpleado_id())));
      out.write("\" class=\"formEdit btn btn-xs btn-primary edit_button\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Editar empleado\"><i class=\"fa fa-edit\"></i></a>                                \n");
      out.write("                                <a href=\"fotografia/index.jsp?i=");
      out.print(_encript.ValorAEncriptar(Integer.toString(item.getEmpleado_id())));
      out.write("\"  class=\"btn btn-xs btn-warning edit_button\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Fotografia\"><i class=\"fa fa-picture-o\"></i></a>                                \n");
      out.write("                                <a data-id=\"");
      out.print(_encript.ValorAEncriptar(Integer.toString(item.getEmpleado_id())));
      out.write("\" class=\"formEliminar btn btn-danger btn-xs delete_button\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Eliminar empleado\"> <i class=\"fa fa-trash-o\"></i></a>                                \n");
      out.write("                            </div>\n");
      out.write("                        </td>\n");
      out.write("                        </tr>\n");
      out.write("                        ");
      ...
      out.write("    });\n");
      out.write("\n");
      out.write("    $(\".formCargo\").click(function (e) {\n");
      out.write("        $(\".modal-dialog\").width(\"66%\");\n");
      out.write("        $(\"#titleModal\").html(\"Lista de cargos\");\n");
      ...
      out.write("\n");
      out.write("        $.post('cargo/index.jsp',\n");
      ...
      out.write("        $(\"#titleModal\").html(\"Editar empleado\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("\n");
      out.write("        $('#formulario_registro').modal('show');\n");
      ...
      out.write("        $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("\n");
      out.write("        $.post('editarEmpleado.jsp',\n");
      out.write("                {id: $(this).attr('data-id')},\n");
      out.write("                function (html) {\n");
      out.write("                    $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                    $(\".cuerpo_registro\").html(html);\n");
      ...
      out.write("        $(\".modal-dialog\").width(600);\n");
      out.write("        $(\"#titleModal\").html(\"Eliminar empleado\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("\n");
      out.write("        $('#formulario_registro').modal('show');\n");
      ...
      out.write("        $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("\n");
      out.write("        $.post('eliminarEmpleado.jsp',\n");
      out.write("                {id: $(this).attr('data-id')},\n");
      out.write("                function (html) {\n");
      out.write("                    $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                    $(\".cuerpo_registro\").html(html);\n");
      ...
      out.write("        $(\".modal-dialog\").width(600);\n");
      out.write("        $(\"#titleModal\").html(\"Registrar empleado\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("        $('#formulario_registro').modal('show');\n");
      out.write("        $(\".cuerpo_registro\").html('');\n");
      ...
      out.write("        $.post('crearEmpleado.jsp',\n");
      out.write("                {id: $(this).attr('data-id')},\n");
      out.write("                function (html) {\n");
      out.write("                    $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                    $(\".cuerpo_registro\").html(html);\n");
      ...
      out.write("    });\n");
      out.write("\n");
      out.write("    $(\".formPhoto\").click(function (e) {\n");
      out.write("        $(\".modal-dialog\").width(600);\n");
      out.write("        $(\"#titleModal\").html(\"Editar Fotografia\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("\n");
      out.write("        $('#formulario_registro').modal('show');\n");
