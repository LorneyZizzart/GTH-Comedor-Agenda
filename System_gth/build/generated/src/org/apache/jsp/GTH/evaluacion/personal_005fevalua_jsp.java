...
public final class personal_005fevalua_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/GTH/evaluacion/../../masterPage/complemento/head.jsp");
    _jspx_dependants.add("/GTH/evaluacion/../../masterPage/complemento/menu.jsp");
    _jspx_dependants.add("/GTH/evaluacion/../../masterPage/complemento/footer.jsp");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    listaEmpleado = ciclo.getEmpleados();
      ...
      out.write("    <h1>\n");
      out.write("        GTH \n");
      out.write("        <small> Evaluar</small>\n");
      out.write("    </h1>\n");
      out.write("    <ol class=\"breadcrumb\">\n");
      out.write("        <li><a href=\"#\"><i class=\"fa fa-dashboard\"></i> Inicio</a></li>\n");
      out.write("        <li class=\"active\">Personal a evaluar</li>\n");
      out.write("    </ol>\n");
      out.write("</section>\n");
      out.write("\n");
      ...
      out.write("                    <h3 class=\"box-title\">Lista personal a evaluar ");
      out.print(ciclo.getNombre());
      out.write("</h3>                    \n");
      out.write("                </div>\n");
      out.write("                <div class=\"box-body table-responsive\">\n");
      out.write("                    <input type=\"hidden\" name=\"id_ciclo_gestion\" id=\"id_ciclo_gestion\" value=\"");
      out.print(id_ciclo);
      out.write("\" >\n");
      out.write("                    <table  id=\"example1\" class=\"table table-bordered table-striped\">\n");
      out.write("                        <thead>\n");
      out.write("                            <tr>\n");
      out.write("                                <th>#</th><th>Departamento</th><th>Nombre</th><th>Cargo</th><th>Estado</th><th></th>\n");
      out.write("                            </tr>\n");
      out.write("                        </thead>\n");
      out.write("                        <tbody>\n");
      out.write("                            ");
 ...
 if (item.getEstado_evaluadores() == -1) {
      out.write("\n");
      out.write("                                    <a href=\"#\" class=\"btn btn-xs btn-danger\" data-toggle=\"tooltip\" data-placement=\"bottom\" data-original-title=\"No tiene evaluación  \">\n");
 ...
 if (item.getEstado_evaluadores() == 0) {
      out.write("\n");
      out.write("                                    <a href=\"#\" class=\"btn btn-xs btn-danger\" data-toggle=\"tooltip\" data-placement=\"bottom\" data-original-title=\"Elegir Evaluadores\">\n");
      out.write("                                        <i class=\"fa fa-user\"></i>\n");
 ...
 if (item.getEstado_evaluadores() == 1) {
      out.write("\n");
      out.write("                                    <a href=\"#\" class=\"btn btn-xs btn-warning\" data-toggle=\"tooltip\" data-placement=\"bottom\" data-original-title=\"Completar Evaluadores\">\n");
      out.write("                                        <i class=\"fa fa-user\"></i>                                         \n");
 ...
 if (item.getEstado_evaluadores() == 2) {
      out.write("\n");
      out.write("                                    <a href=\"#\" class=\"btn btn-xs btn-success\" data-toggle=\"tooltip\" data-placement=\"bottom\" data-original-title=\"Evaluadores Completado\">\n");
      out.write("                                        <i class=\"fa fa-user\"></i>\n");
      out.write("                                        <i class=\"fa fa-check\"></i>\n");
      out.write("                                        <i class=\"fa fa-check\"></i>\n");
      out.write("                                    </a>\n");
      ...
      out.write("\n");
      out.write("\n");
      out.write("                                    <!-- esta parte para el estado de correo -->\n");
      out.write("                                    ");
//=item.getEstado_correo()
 ...
 if (item.getEstado_correo() <= 0) {
      ...
      out.write("\n");
      out.write("                                    <a href=\"#\" class=\"btn btn-xs btn-danger\" data-toggle=\"tooltip\" data-placement=\"bottom\" data-original-title=\"No se envió correos\">\n");
 ...
 if (item.getEstado_correo() == 1) {
      out.write("\n");
      out.write("                                    <a href=\"#\" class=\"btn btn-xs btn-warning\" data-toggle=\"tooltip\" data-placement=\"bottom\" data-original-title=\"Completar Envió correo\">\n");
      out.write("                                        <i class=\"fa fa-envelope\"></i>                                         \n");
      out.write("                                        <i class=\"fa fa-check\"></i>\n");
      out.write("                                        <i class=\"fa\">....</i>\n");
      out.write("                                    </a>\n");
 ...
 if (item.getEstado_correo() == 2) {
      out.write("\n");
      out.write("                                    <a href=\"#\" class=\"btn btn-xs btn-success\" data-toggle=\"tooltip\" data-placement=\"bottom\" data-original-title=\"Correos Enviados\">\n");
      out.write("                                        <i class=\"fa fa-envelope\"></i>\n");
      out.write("                                        <i class=\"fa fa-check\"></i>\n");
      out.write("                                        <i class=\"fa fa-check\"></i>\n");
      out.write("                                    </a>\n");
      ...
      out.write("                                </td>\n");
      out.write("                                <td>\n");
      out.write("                                    <a class=\"btn btn-xs btn-success add_evaluator\" data-idEmple=\"");
      out.print(item.getEmpleado_id());
      out.write("\" data-gestion=\"");
      out.print(ciclo.getCuestionario_gestion_id());
      out.write("\"> \n");
      out.write("                                        <i class=\"fa fa-user\"></i>\n");
      out.write("                                        Añadir Evaluador\n");
      out.write("                                    </a>\n");
      out.write("                                    <a class=\"btn btn-xs btn-warning send_mail_view\" data-idEmple=\"");
      out.print(item.getEmpleado_id());
      out.write("\" data-gestion=\"");
      out.print(ciclo.getCuestionario_gestion_id());
      out.write("\">\n");
      ...
      out.write("                                    </a>\n");
      out.write("                                    <a class=\"btn btn-xs btn-info tracing_view\" data-idEmple=\"");
      out.print(item.getEmpleado_id());
      out.write("\" data-gestion=\"");
      out.print(ciclo.getCuestionario_gestion_id());
      out.write("\">\n");
      out.write("                                        <i class=\"fa fa-search\"></i>\n");
      out.write("                                        Ver seguimiento \n");
      out.write("                                    </a>\n");
      out.write("                                </td>\n");
      out.write("                            </tr>\n");
      out.write("                            ");
      ...
      out.write("\n");
      out.write("<!--Modal-->\n");
      out.write("<div class=\"modal fade\" id=\"mod_lista_cuestionario\">\n");
      ...
      out.write("            </div>\n");
      out.write("            <div class=\"modal-body cuerpo_cuestionario\">\n");
      ...
      out.write("\n");
      out.write("<!--Modal-->\n");
      out.write("<div class=\"modal fade\" id=\"mod_vista_enviar_correo\">\n");
      out.write("    <div class=\"modal-dialog\" style=\"width:90%;\">\n");
      out.write("        <div class=\"modal-content\">\n");
      out.write("            <div class=\"modal-header\">\n");
      out.write("                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n");
      out.write("                    <span aria-hidden=\"true\">&times;</span></button>\n");
      out.write("                <h4 id=\"titleModal_correo\" class=\"modal-title\">title</h4>\n");
      out.write("            </div>\n");
      out.write("            <div class=\"modal-body cuerpo_ver_envia_correo\">\n");
      out.write("                <button type=\"button\" class=\"btn btn-default pull-left\" data-dismiss=\"modal\"><i class=\"fa fa-close\"></i> Cancelar</button>\n");
      out.write("            </div>\n");
      out.write("        </div>\n");
      out.write("        <!-- /.modal-content -->\n");
      ...
      out.write("\n");
      out.write("<!--Modal-->\n");
      out.write("<div class=\"modal fade\" id=\"mod_vista_seguimiento\">\n");
      out.write("    <div class=\"modal-dialog\">\n");
      out.write("        <div class=\"modal-content\">\n");
      out.write("            <div class=\"modal-header\">\n");
      out.write("                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n");
      out.write("                    <span aria-hidden=\"true\">&times;</span></button>\n");
      out.write("                <h4 id=\"titleModal_seguimiento\" class=\"modal-title\">title</h4>\n");
      out.write("            </div>\n");
      out.write("            <div class=\"modal-body cuerpo_ver_seguimiento\">\n");
      out.write("                <button type=\"button\" class=\"btn btn-default pull-left\" data-dismiss=\"modal\"><i class=\"fa fa-close\"></i> Cancelar</button>\n");
      out.write("            </div>\n");
      out.write("        </div>\n");
      out.write("        <!-- /.modal-content -->\n");
      ...
      out.write("        });\n");
      out.write("        $(\".send_mail_view\").on(\"click\", function () {\n");
      out.write("            var id_empleado = $(this).attr('data-idEmple');\n");
      out.write("            var id_ciclo = $(this).attr('data-gestion');\n");
      out.write("            //alert(id_empleado + \" \" + id_ciclo);*/\n");
      out.write("            $(\"#titleModal_correo\").html(\"Enviar Correo Electronico \");\n");
      out.write("            $('#mod_vista_enviar_correo').modal('show');\n");
      out.write("            $(\".cuerpo_ver_envia_correo\").html('');\n");
      out.write("            $(\".cuerpo_ver_envia_correo\").addClass('loader');\n");
      out.write("            $.post('ver_enviar_correo.jsp',\n");
      out.write("                    {id_emple: id_empleado,\n");
      out.write("                        id_ciclo: id_ciclo},\n");
      out.write("                    function (html) {\n");
      out.write("                        $(\".cuerpo_ver_envia_correo\").removeClass('loader');\n");
      out.write("                        $(\".cuerpo_ver_envia_correo\").html(html);\n");
      out.write("                    }\n");
      out.write("            ).fail(function (jqXHR, textStatus, errorThrown)\n");
      out.write("            {\n");
      out.write("                var alerta = \"<p class='bg-danger'>error: \" + errorThrown + \"</p>\";\n");
      out.write("                $(\".cuerpo_ver_envia_correo\").removeClass('loader');\n");
      out.write("                $(\".cuerpo_ver_envia_correo\").html(alerta);\n");
      out.write("            });\n");
      out.write("        });\n");
      out.write("        $(\".add_evaluator\").on(\"click\", function () {\n");
      out.write("            //console.log($(this).text());\n");
      out.write("            var id_empleado = $(this).attr('data-idEmple');\n");
      out.write("            var id_ciclo = $(this).attr('data-gestion');\n");
      out.write("            //alert(id_empleado + \" \" + id_ciclo);*/\n");
      out.write("            $(\"#titleModal\").html(\"Lista Evaluaciones \");\n");
      out.write("            $('#mod_lista_cuestionario').modal('show');\n");
      out.write("            $(\".cuerpo_cuestionario\").html('');\n");
      out.write("            $(\".cuerpo_cuestionario\").addClass('loader');\n");
      out.write("\n");
      out.write("            $.post('muestra_lista_evaluacion.jsp',\n");
      out.write("                    {id_emple: id_empleado,\n");
      out.write("                        id_ciclo: id_ciclo},\n");
      out.write("                    function (html) {\n");
      out.write("                        $(\".cuerpo_cuestionario\").removeClass('loader');\n");
      out.write("                        $(\".cuerpo_cuestionario\").html(html);\n");
      out.write("                    }\n");
      out.write("            ).fail(function (jqXHR, textStatus, errorThrown)\n");
      out.write("            {\n");
      out.write("                var alerta = \"<p class='bg-danger'>error: \" + errorThrown + \"</p>\";\n");
      out.write("                $(\".cuerpo_cuestionario\").removeClass('loader');\n");
      out.write("                $(\".cuerpo_cuestionario\").html(alerta);\n");
      out.write("            });\n");
      out.write("        });\n");
      out.write("        \n");
      out.write("        $(\".tracing_view\").on(\"click\", function () {\n");
      out.write("            var id_empleado = $(this).attr('data-idEmple');\n");
      out.write("            var id_ciclo = $(this).attr('data-gestion');\n");
      out.write("            //alert(id_empleado + \" \" + id_ciclo);*/\n");
      out.write("            $(\"#titleModal_seguimiento\").html(\"Seguimiento a evaluación\");\n");
      out.write("            $('#mod_vista_seguimiento').modal('show');\n");
      out.write("            $(\".cuerpo_ver_seguimiento\").html('');\n");
      out.write("            $(\".cuerpo_ver_seguimiento\").addClass('loader');\n");
      out.write("            $.post('ver_seguimiento.jsp',\n");
      out.write("                    {id_emple: id_empleado,\n");
      out.write("                        id_ciclo: id_ciclo},\n");
      out.write("                    function (html) {\n");
      out.write("                        $(\".cuerpo_ver_seguimiento\").removeClass('loader');\n");
      out.write("                        $(\".cuerpo_ver_seguimiento\").html(html);\n");
      out.write("                    }\n");
      out.write("            ).fail(function (jqXHR, textStatus, errorThrown)\n");
      out.write("            {\n");
      out.write("                var alerta = \"<p class='bg-danger'>error: \" + errorThrown + \"</p>\";\n");
      out.write("                $(\".cuerpo_ver_seguimiento\").removeClass('loader');\n");
      out.write("                $(\".cuerpo_ver_seguimiento\").html(alerta);\n");
      out.write("            });\n");
      out.write("        });\n");
      out.write("        \n");
      out.write("        \n");
