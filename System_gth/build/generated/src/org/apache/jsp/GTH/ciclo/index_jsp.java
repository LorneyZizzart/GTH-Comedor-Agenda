...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    listaCiclos = _ciclo.GetAllCuestionario_gestion();
      ...
      out.write("    <h1>\n");
      out.write("        Registro \n");
      out.write("        <small> de Ciclos</small>\n");
      out.write("    </h1>\n");
      out.write("    <ol class=\"breadcrumb\">\n");
      out.write("        <li><a href=\"#\"><i class=\"fa fa-dashboard\"></i> Inicio</a></li>\n");
      out.write("        <li class=\"active\">Lista de Ciclos</li>\n");
      out.write("    </ol>\n");
      out.write("</section>\n");
      out.write("\n");
      ...
      out.write("                    <h3 class=\"box-title\">Lista de Ciclos</h3>\n");
      out.write("                    <a href=\"crearCiclo.jsp\" class=\"btn-purple btn-right_nivel\" data-toggle=\"tooltip\" title=\"Añadir ciclo\"><i class=\"fa fa-plus\"></i></a>   \n");
      out.write("\n");
...
String idEncripta = _encript.ValorAEncriptar(Integer.toString(item.getCuestionario_gestion_id()));
      out.write(" \n");
      out.write("                                <a href=\"../evaluacion/personal_evalua.jsp?c=");
      out.print(idEncripta);
      out.write("\" class=\"btn btn-xs btn-info\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Evaluar Personal\"><i class=\"fa fa-plus\"></i></a>  \n");
      out.write("                                <a href=\"editarCiclo.jsp?c=");
      out.print(idEncripta);
      out.write("\" class=\"btn btn-xs btn-primary\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Editar\"><i class=\"fa fa-edit\"></i></a>                                \n");
      out.write("                                <a data-id=\"");
      out.print(idEncripta);
      out.write("\" class=\"formDelet btn btn-danger btn-xs\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Eliminar\"> <i class=\"fa fa-trash-o\"></i></a>                                \n");
      out.write("                                <a class=\"formCorreo btn bg-yellow btn-xs\" data-id=\"");
      out.print(item.getCuestionario_gestion_id());
      out.write("\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Edita Correo\"> <i class=\"fa fa-envelope-o\"></i></a>\n");
      out.write("                            </div>\n");
      out.write("                        </td>\n");
      out.write("                        </tr>\n");
      out.write("                        ");
      ...
      out.write("\n");
      out.write("    <!-- /.row -->\n");
      out.write("    <div class=\"modal fade\" id=\"correo_editar\">\n");
      out.write("        <div class=\"modal-dialog modal-lg\">\n");
      out.write("            <div class=\"modal-content\">\n");
      out.write("                <div class=\"modal-header\">\n");
      out.write("                    <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n");
      out.write("                        <span aria-hidden=\"true\">&times;</span></button>\n");
      out.write("                    <h4 id=\"titleModalcorreo\" class=\"modal-title\">title</h4>\n");
      out.write("                </div>\n");
      out.write("                <div class=\"modal-body cuerpo_correo\"></div>\n");
      out.write("            </div>\n");
      out.write("            <!-- /.modal-content -->\n");
      out.write("        </div>\n");
      out.write("        <!-- /.modal-dialog -->\n");
      ...
      out.write("    $('.title').tooltip({boundary: 'window'})\n");
      out.write("\n");
      out.write("    $(function () {\n");
      out.write("        $(\"#example1\").DataTable();\n");
      out.write("    });\n");
      out.write("\n");
      out.write("    $(\".formCorreo\").click(function (e) {\n");
      out.write("        \n");
      out.write("        $(\"#titleModalcorreo\").html(\"Crear Correo Electronico\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("\n");
      out.write("        $('#correo_editar').modal('show');\n");
      out.write("        $(\".cuerpo_correo\").html('');\n");
      out.write("        $(\".cuerpo_correo\").addClass('loader');\n");
      out.write("\n");
      out.write("        $.post('correo_electronico_edit.jsp',\n");
      out.write("                {id: $(this).attr('data-id')},\n");
      out.write("                function (html) {\n");
      out.write("                    $(\".cuerpo_correo\").removeClass('loader');\n");
      out.write("                    $(\".cuerpo_correo\").html(html);\n");
      out.write("                }\n");
      out.write("        ).fail(function (jqXHR, textStatus, errorThrown)\n");
      out.write("        {\n");
      out.write("            var alerta = \"<p class='bg-danger'>error: \" + errorThrown + \"</p>\";\n");
      out.write("            $(\".cuerpo_correo\").removeClass('loader');\n");
      out.write("            $(\".cuerpo_correo\").html(alerta);\n");
      out.write("        });\n");
      out.write("\n");
      out.write("\n");
      out.write("    });\n");
      ...
      out.write("        $(\"#titleModal\").html(\"Crear Ciclo\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("        $('#formulario_registro').modal('show');\n");
      out.write("        $(\".cuerpo_registro\").html('');\n");
      out.write("        $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("        $.post('crearCiclo.jsp',\n");
      out.write("                {id: $(this).attr('data-id'), idUser: $(\"#idUsuario\").val()},\n");
      out.write("                function (html) {\n");
      ...
      out.write("        $(\"#titleModal\").html(\"Editar ciclo\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("\n");
      out.write("        $('#formulario_registro').modal('show');\n");
      out.write("        $(\".cuerpo_registro\").html('');\n");
      out.write("        $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("        var idUser = $(\"#idUsuario\").val();\n");
      out.write("        $.post('editarCiclo.jsp',\n");
      out.write("                {id: $(this).attr('data-id'), idUser: idUser},\n");
      out.write("                function (html) {\n");
      out.write("                    $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                    $(\".cuerpo_registro\").html(html);\n");
      out.write("                }\n");
      ...
      out.write("\n");
      out.write("    });\n");
      out.write("    $(\".formDelet\").click(function (e) {\n");
      out.write("        $(\"#titleModal\").html(\"Eliminar ciclo\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("\n");
      out.write("        $('#formulario_registro').modal('show');\n");
      ...
      out.write("        $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("\n");
      out.write("        $.post('eliminarCiclo.jsp',\n");
      out.write("                {id: $(this).attr('data-id')},\n");
      out.write("                function (html) {\n");
      out.write("                    $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                    $(\".cuerpo_registro\").html(html);\n");
