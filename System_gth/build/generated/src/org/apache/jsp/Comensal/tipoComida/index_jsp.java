...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/Comensal/tipoComida/../../masterPage/complemento/head.jsp");
    _jspx_dependants.add("/Comensal/tipoComida/../../masterPage/complemento/menu.jsp");
    _jspx_dependants.add("/Comensal/tipoComida/../../masterPage/complemento/footer.jsp");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    listaTipoComida = _tipoComida.getAllTipoComida();
      ...
      out.write("    <h1>\n");
      out.write("        Registro\n");
      out.write("        <small> Tipo de Comidas</small>\n");
      out.write("    </h1>\n");
      ...
      out.write("                    <h3 class=\"box-title\">Tipos de Comidas</h3>\n");
      out.write("                    <button type=\"button\" class=\"formNuevo btn-purple pull-right\" data-toggle=\"modal tooltip\" data-target=\"#modal-default\" data-placement=\"bottom\" title=\"Añadir tipo de comida\">\n");
      ...
      out.write("                                <th>Horas de anticipación</th>\n");
      ...
      out.write("</td>\n");
      out.write("                                <td><span class=\"badge\" style=\"background-color: ");
 ...
 if (item.getEstado() == 1) {
      ...
      out.write("                                        <a data-id=\"");
      out.print(_encript.ValorAEncriptar(Integer.toString(item.getIdTipoComida())));
      ...
      out.write("        $(\"#titleModal\").html(\"Crear tipo de Comida\");\n");
      ...
      out.write("            $.post('crearTipoComida.jsp',\n");
      ...
      out.write("        $(\"#titleModal\").html(\"Editar tipo de Comida\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("        \n");
      out.write("        $('#formulario_registro').modal('show');\n");
      ...
      out.write("        $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("        \n");
      out.write("        $.post('editarTipoComida.jsp',\n");
      out.write("            {id: $(this).attr('data-id')},\n");
      out.write("                    function (html) {\n");
      out.write("                    $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                    $(\".cuerpo_registro\").html(html);\n");
      ...
      out.write("        $(\"#titleModal\").html(\"Eliminar tipo de Comida\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("        \n");
      out.write("        $('#formulario_registro').modal('show');\n");
      ...
      out.write("        $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("        \n");
      out.write("        $.post('eliminarTipoComida.jsp',\n");
      out.write("            {id: $(this).attr('data-id')},\n");
      out.write("                    function (html) {\n");
      out.write("                    $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                    $(\".cuerpo_registro\").html(html);\n");
