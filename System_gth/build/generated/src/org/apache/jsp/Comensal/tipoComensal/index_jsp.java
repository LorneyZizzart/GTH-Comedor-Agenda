...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/Comensal/tipoComensal/../../masterPage/complemento/head.jsp");
    _jspx_dependants.add("/Comensal/tipoComensal/../../masterPage/complemento/menu.jsp");
    _jspx_dependants.add("/Comensal/tipoComensal/../../masterPage/complemento/footer.jsp");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    lista = _tipoComensal.getAllTipoComensal();
      ...
      out.write("    <h1>\n");
      out.write("        Registro\n");
      out.write("        <small> de comensales</small>\n");
      out.write("    </h1>\n");
      out.write("    <ol class=\"breadcrumb\">\n");
      out.write("        <li><a href=\"#\"><i class=\"fa fa-dashboard\"></i> Inicio</a></li>\n");
      out.write("        <li class=\"active\">Lista de comensales</li>\n");
      out.write("    </ol>\n");
      out.write("</section>\n");
      out.write("\n");
      ...
      out.write("                    <h3 class=\"box-title\">Lista de Comensales</h3>\n");
      out.write("                    <a data-id=\"");
      out.print(_encript.ValorAEncriptar(Integer.toString(DatoUsuario.getUser_id())));
      out.write("\" style=\"cursor:pointer;\" class=\"formNuevo btn-purple pull-right\" data-toggle=\"modal tooltip\" data-target=\"#modal-default\" data-placement=\"bottom\" title=\"Añadir comensal\">\n");
      ...
      out.write("                                <th>Descuento desayuno</th>  \n");
      out.write("                                <th>Descuento almuerzo</th>  \n");
      out.write("                                <th>Descuento cena</th>  \n");
      out.write("                                <th>Día inicio</th>     \n");
      out.write("                                <th>Día fin</th>  \n");
      out.write("                                <th>Usuario creado</th>                                \n");
      ...
      out.write("</td>\n");
      out.write("                                <td>");
      out.print(_character.CharacterUCFirst(item.getNombreComensal()));
      out.write("</td>                         \n");
      out.write("                                <td>");
      ...
      out.write(" Bs.</td>\n");
      out.write("                                <td>");
      out.print( item.getDiaInicio());
      out.write("</td>\n");
      out.write("                                <td>");
      out.print( item.getDiaFin());
      out.write("</td>\n");
      out.write("                                <td>");
      out.print( item.getUsuarioCrea());
      out.write("</td>\n");
      out.write("                                <td>");
 ...
 if (item.getEstado() == 1) {
      ...
      out.write("                                        <a data-id=\"");
      out.print(_encript.ValorAEncriptar(Integer.toString(item.getTipoComensal_id())));
      ...
      out.write("        $(\"#titleModal\").html(\"Crear comensal\");\n");
      ...
      out.write("            $.post('crearComensal.jsp',\n");
      ...
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("        $(\"#titleModal\").html(\"Editar comensal\");\n");
      out.write("        $('#formulario_registro').modal('show');\n");
      out.write("        $(\".cuerpo_registro\").html('');\n");
      out.write("        $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("        $.post('editarComensal.jsp',\n");
      out.write("            {id: $(this).attr('data-id')},\n");
      out.write("                    function (html) {\n");
      out.write("                    $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                    $(\".cuerpo_registro\").html(html);\n");
      ...
      out.write("        $(\"#titleModal\").html(\"Eliminar comensal\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("        \n");
      out.write("        $('#formulario_registro').modal('show');\n");
      ...
      out.write("        $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("        \n");
      out.write("        $.post('eliminarComensal.jsp',\n");
      out.write("            {id: $(this).attr('data-id')},\n");
      out.write("                    function (html) {\n");
      out.write("                    $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                    $(\".cuerpo_registro\").html(html);\n");
