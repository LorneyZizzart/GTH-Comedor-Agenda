...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/Comensal/editarReservas/../../masterPage/complemento/head.jsp");
    _jspx_dependants.add("/Comensal/editarReservas/../../masterPage/complemento/menu.jsp");
    _jspx_dependants.add("/Comensal/editarReservas/../../masterPage/complemento/footer.jsp");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    String Fecha = request.getParameter("Fecha");
      ...
      out.write("                         <div class=\"form-group\">\n");
      out.write("                                <label class=\"col-md-4 control-label\" style=\"padding: 1% 0 0 0;\">Tipos de comensal:</label>\n");
      out.write("                                <div class=\"col-md-8 col-xs-12 input-group\">\n");
      ...
      out.write("                    <div class=\"col-sm-12 col-md-3\">\n");
      out.write("                        <div class=\"form-group\">\n");
      out.write("                            <label class=\"col-md-6 col-sm-12 col-lg-4control-label\" style=\"padding: 2% 0 0 0;\">Comensal:</label>\n");
      out.write("                            <div class=\"col-md-6 col-sm-12 col-lg-8 input-group\">\n");
 ...
 c++; }  
      ...
      out.write(" \n");
      out.write("<script>\n");
      out.write("    function formato(texto){\n");
      out.write("        return texto.replace(/^(\\d{4})-(\\d{2})-(\\d{2})$/g,'$3/$2/$1');\n");
      out.write("    }\n");
      out.write("    \n");
      ...
      out.print(palabra);
      out.write(" == \"1\"){\n");
      out.write("            renderTable(\"0%2\", 0, \"\", \"\", 0, 0, 1, $('#tipoFuncionario').val());\n");
      out.write("        }else{\n");
      out.write("            if(");
      out.print(palabra);
      out.write(" == \"2\"){\n");
      ...
      out.print(IdTipoComensal);
      out.write("'+'%1', 2, formato(fechaInicio), formato(fechaFinal), ['0'], ['");
      out.print(IdTipoComida);
      out.write("'], 0, $('#tipoFuncionario').val());\n");
      out.write("            }else{\n");
      out.write("                renderTable(\"0%2\", $('#idRepeat').val(), fechaInicio, fechaFinal, $('#idTipoCo').val(), $('#idTipoAl').val(), 0, $('#tipoFuncionario').val());\n");
      out.write("            }\n");
      out.write("        }\n");
      out.write("        \n");
      out.write("    });\n");
      ...
      out.write("        renderTable($('#idEmpleado').val(), $('#idRepeat').val(), fechaInicio, fechaFinal, $('#idTipoCo').val(), $('#idTipoAl').val(), 0, $('#tipoFuncionario').val());\n");
      out.write("    });\n");
      out.write("    \n");
      out.write("//    ====================== SillegaParametroListar todas\n");
      out.write("    \n");
      ...
      out.write("    }\n");
      out.write("    \n");
      out.write("    function VerTodasNotificaciones(){\n");
      out.write("        console.log(\"daniasbfd\");\n");
      out.write("//        $('#dp1').prop('disabled', valor);\n");
      out.write("//        $('#dp2').prop('disabled', valor);\n");
      out.write("    }\n");
      out.write("    \n");
      ...
      out.write("    });\n");
      out.write("    \n");
      out.write("    function renderTable(idE, idR, fi, ff, co, al, No, tipoFuncionario){\n");
      out.write("        $.post('listaReserva.jsp',\n");
      out.write("            {idEmpleado:idE, idRepeticion:idR, fi:fi, ff:ff, co:co, al:al, No:No, tipoFuncionario:tipoFuncionario},\n");
      out.write("                    function (html) {\n");
