...
public final class crearTarea_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    listaEstadoTarea = _estadoTarea.getAllEstadoTarea();
      ...
      out.write("                            <!--<textarea id=\"descripcion\"  name=\"descripcion\"></textarea>-->\n");
      out.write("                        </div>\n");
      out.write("                        <div class=\"form-group\">\n");
      out.write("                            <label>Cargar imagen </label>\n");
      out.write("                            <input type=\"text\" class=\"form-control\" id=\"tituloImage\"  name=\"tituloImage\" placeholder=\"Título de la imagen\"> \n");
      out.write("                            <input name=\"file-input\" id=\"file-input\" type=\"file\"/>\n");
      out.write("                        </div>\n");
      ...
      out.write("    \n");
      out.write("    var numImage = 1;\n");
      out.write("    \n");
      out.write("    $(\"#file-input\").click(function (e) {\n");
      out.write("        \n");
      out.write("        \n");
      out.write("        \n");
      out.write("        console.log(\"num: \", numImage);\n");
      out.write("    });\n");
      out.write("    \n");
      out.write("\n");
      out.write(" $(function() {\n");
      ...
      out.write("        $('#divImage').append('<div id=\"divimgSalida'+numImage+'\" class=\"col-md-2 text-center cont-image\" style=\"border: solid 1px #aba8a8; margin: 2px;padding: 0;\"> \\n\\\n");
      out.write("                                <label id=\"imgSalida'+numImage+'\">'+$('#tituloImage').val()+'</label>\\n\\\n");
      out.write("                                <a onclick=\"eliminarImagen(imgSalida'+numImage+')\" id=\"imgSalida'+numImage+'\" type=\"button\" class=\"btn-purple pull-right eliminarImage\" style=\"padding: 0px 4px;cursor:pointer;\"><i class=\"fa fa-close\"></i></a>\\n\\\n");
      ...
      out.write("      \n");
      out.write("      $.post('guardarFile.jsp',\n");
      out.write("            {id: 1, path:result},\n");
      out.write("                    function (html) {\n");
      out.write("                    $(\"#imgSalida\"+numImage).removeClass('loader');\n");
      out.write("                    $(\"#imgSalida\"+numImage).html(html);\n");
      out.write("                    }\n");
      out.write("             ).fail(function (jqXHR, textStatus, errorThrown)\n");
      out.write("            {\n");
      out.write("                var alerta = \"<p class='bg-danger'>error: \"+errorThrown+\"</p>\";\n");
      out.write("                $(\"#imgSalida\"+numImage).removeClass('loader');\n");
      out.write("                $(\"#imgSalida\"+numImage).html(alerta);\n");
      out.write("            });\n");
      out.write("     numImage++; \n");
      ...
      out.write("        $(\"#div\"+e[1].id).remove();\n");
      out.write("    }\n");
      out.write("    \n");
      out.write("    $(document).ready(function () {\n");
      out.write("//\n");
      out.write("//        $('#descripcion').Editor();\n");
      out.write("//        $('#descripcion').Editor('setText', ['<p style=\"color:#a29e9e;\">Descripción de la tarea</p>']);\n");
