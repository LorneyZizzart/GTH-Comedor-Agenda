...
public final class crearTarea_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    calendar.add(Calendar.DAY_OF_YEAR, -1);
      ...
      out.write("    <input type=\"hidden\" value=\"");
      out.print(dataStart[2]);
      out.write('/');
      out.print(dataStart[1]);
      out.write('/');
      out.print(dataStart[0]);
      out.write("\" name=\"fi\" id=\"fi\">\n");
      out.write("    <input type=\"hidden\" value=\"");
      out.print(String.valueOf(calendar.get(Calendar.YEAR)+"/"+(Integer.parseInt(String.valueOf(calendar.get(Calendar.MONTH)))+1)+"/"+calendar.get(Calendar.DATE)));
