...
public final class listFile_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    listaP = _path.getAllPath(Integer.parseInt(idTarea));
      ...
      out.write("    });\n");
      out.write("    \n");
      out.write("    function downloadLink(url) {\n");
      out.write("    \tvar ajaxOptions = {\n");
      out.write("    \t\turl: url\n");
      out.write("        };\n");
      out.write("        \n");
      out.write("        var res = $.ajax(ajaxOptions);\n");
      out.write("        \n");
      out.write("        function onAjaxDone(data) {          \n");
      out.write("        \t\tlocation.href = url\n");
      out.write("        }\n");
      out.write("        \n");
      out.write("        function onAjaxFail() {\n");
      out.write("        \talert('Error al descargar');\n");
      out.write("        }\n");
      out.write("        \n");
      out.write("        res.done(onAjaxDone).fail(onAjaxFail);\n");
      out.write("    }\n");
      out.write("    \n");
      out.write("    $(\".DownloadFile\").click(function (e) {\n");
      out.write("        var url = $(this).attr('data-id');\n");
      out.write("    \te.preventDefault();\n");
      out.write("        downloadLink(url);\n");
      out.write("    \n");
      out.write("    });\n");
      out.write("                            \n");
      out.write("</script>");
