...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 c++; }  
      ...
      out.write("        renderTable($('#idUsuario').val(), 0);\n");
      out.write("          \n");
      out.write("    });\n");
      out.write("    $('#idRepeat').on('change', function() {       \n");
      out.write("        renderTable($('#idUsuario').val(), this.value);\n");
      out.write("    });\n");
      out.write("    \n");
      out.write("    function renderTable(idU, idR){\n");
      out.write("        $.post('listaTarea.jsp',\n");
      out.write("            {idUsuario: idU, idRepeat: idR},\n");
      out.write("                    function (html) {\n");
