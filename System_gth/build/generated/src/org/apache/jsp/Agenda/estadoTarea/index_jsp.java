...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/Agenda/estadoTarea/../../masterPage/complemento/head.jsp");
    _jspx_dependants.add("/Agenda/estadoTarea/../../masterPage/complemento/menu.jsp");
    _jspx_dependants.add("/Agenda/estadoTarea/../../masterPage/complemento/footer.jsp");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    lista = _estadoTarea.getAllEstadoTarea();
      ...
      out.write("    <h1>\n");
      out.write("        Registro\n");
      out.write("        <small> Estados de tarea</small>\n");
      out.write("    </h1>\n");
      out.write("    <ol class=\"breadcrumb\">\n");
      out.write("        <li><a href=\"#\"><i class=\"fa fa-dashboard\"></i> Inicio</a></li>\n");
      out.write("        <li class=\"active\">Lista estados de tarea</li>\n");
      out.write("    </ol>\n");
      out.write("</section>\n");
      out.write("\n");
      ...
      out.write("                    <h3 class=\"box-title\">Lista estados de tarea</h3>\n");
      out.write("                    <a style=\"cursor:pointer;\" class=\"formNuevo btn-purple pull-right\" data-toggle=\"modal tooltip\" data-target=\"#modal-default\" data-placement=\"bottom\" title=\"Añadir tipo tarea\">\n");
 ...
 if (item.getEstadoEstadoTarea()== 1) {
      ...
      out.write("                                        <a data-id=\"");
      out.print(_encript.ValorAEncriptar(Integer.toString(item.getIdEstadoTarea())));
      ...
      out.write("        $(\"#titleModal\").html(\"Crear estado de tarea\");\n");
      ...
      out.write("            $.post('crearEstadoTarea.jsp',\n");
      ...
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("        $(\"#titleModal\").html(\"Editar estado de tarea\");\n");
      out.write("        $('#formulario_registro').modal('show');\n");
      out.write("        $(\".cuerpo_registro\").html('');\n");
      out.write("        $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("        $.post('editEstadoTarea.jsp',\n");
      out.write("            {id: $(this).attr('data-id')},\n");
      out.write("                    function (html) {\n");
      out.write("                    $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                    $(\".cuerpo_registro\").html(html);\n");
      ...
      out.write("        $(\"#titleModal\").html(\"Eliminar estado de tarea\");\n");
      out.write("        e.preventDefault();\n");
      out.write("        e.stopImmediatePropagation();\n");
      out.write("        \n");
      out.write("        $('#formulario_registro').modal('show');\n");
      ...
      out.write("        $(\".cuerpo_registro\").addClass('loader');\n");
      out.write("        \n");
      out.write("        $.post('eliminarEstadoTarea.jsp',\n");
      out.write("            {id: $(this).attr('data-id')},\n");
      out.write("                    function (html) {\n");
      out.write("                    $(\".cuerpo_registro\").removeClass('loader');\n");
      out.write("                    $(\".cuerpo_registro\").html(html);\n");
