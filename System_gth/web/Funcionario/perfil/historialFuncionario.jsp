        ...
        <div class="col-md-9">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#curriculum" data-toggle="tab">Currículum</a></li>
                    <li><a href="#vacaciones" data-toggle="tab">Solicitud de Vacaciones, Licencia, Permisos</a></li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="datospersonales">
                        <div class="post">
                            <%@ include file= "datoPersonal/datos_personales.jsp" %> 
                        </div>
                    </div>
                    <div class="tab-pane" id="curriculum">
                        <div class="post">
                            <%@ include file= "curriculum/ver_curriculum.jsp" %> 
                        </div>
                    </div>
                    <div class="tab-pane" id="vacaciones">
                        <div class="post">
                            <%@ include file= "vacaciones/vacaciones_opcion.jsp" %> 
                        </div>
                    </div>
