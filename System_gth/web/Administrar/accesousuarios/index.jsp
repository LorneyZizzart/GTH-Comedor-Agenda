        ...
        <div class="col-xs-12">            
            ...
            <div class="box box-purple">
                <div class="box-header">
                    ...
                    <button id="formNuevo" type="button" class="btn-purple btn-right_nivel" data-toggle="modal" data-target="#modal-default" title="Añadir usuario">
                        ...
                        <tbody>  
                            ...
                            <tr>
                                ...
                                <td class="text-center" ><div class="btn-group">
                                        ...
                                        <a data-id="<%=_encript.ValorAEncriptar(Integer.toString(item.getUser_id()))%>" class="formPassword title btn btn-xs btn-primary edit_button" data-toggle="tooltip" data-placement="bottom" title="Editar contraseña"><i class="fa fa-unlock-alt"></i></a>  
...
<script>
    ...
    $(".formPassword").click(function (e) {
        $("#titleModal").html("Editar Contraseña");
        e.preventDefault();
        e.stopImmediatePropagation();
            $('#formulario_registro').modal('show');
            $(".cuerpo_registro").html('');
