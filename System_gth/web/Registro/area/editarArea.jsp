             ...
             <input type="hidden" value="<%=idArea%>" name="id" id="id">
                    <div class="box-body">
                        <div class="form-group">
                            <label>Nombre</label>
                            <input type="text" class="form-control" id="area_nombre"  name="area_nombre" value="<%=_character.CharacterUCFirst(area.getNombre())%>">                            
                        </div>   
                        <div class="form-group">
                            <label>Posición</label>
                            <input type="text" class="form-control" id="posicion"  name="posicion" value="<%=area.getPosicion()%>">                            
                        </div> 
                        <div class="form-group">
                            <label>Estado</label>
                            <%
                            ...
                            %>
                            <label> <input type="checkbox" name="area_estado" id="area_estado"  class="flat-red" <%=select%>></label>
                        </div>   
                    </div>
                    <!-- /.box-body -->
