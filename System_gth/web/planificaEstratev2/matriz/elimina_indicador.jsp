...
<form class="form-horizontal form_indicador_nuevo">
    ...
    <div class="box-body">
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="indi_nombre" name="indi_nombre" placeholder="Nombre" required value="<%=indicador_ver.getNombre()%>" readonly>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" data-date-format='dd/mm/yyyy'  id="indi_fecha" name="indi_fecha" placeholder="dd/mm/yyyy" value="<%=indicador_ver.getFecha()%>" required readonly>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10" >
                <select class="form-control" id="indi_rango" name="indi_rango" required readonly>
                    <%
...
<script>
    $(document).ready(function () {
        ...
        $('.form_indicador_nuevo').bootstrapValidator({
            ...
            $.ajax({
                type: "POST",
                url: "../matriz/elimina_indicador_guarda.jsp",
                data: $form.serialize(),
