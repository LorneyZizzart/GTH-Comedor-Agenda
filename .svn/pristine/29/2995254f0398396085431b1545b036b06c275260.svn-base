...
CREATE TABLE PaisIdioma (
  ...
  PaisIdioma char(30) NOT NULL DEFAULT '',
  PaisIdiomaOficial char(1) NOT NULL DEFAULT 'F',
  PaisIdiomaPorcentaje float NOT NULL DEFAULT '0.0',
  PRIMARY KEY (PaisCodigo,PaisIdioma)
);
...
INSERT INTO PaisIdioma (PaisCodigo, PaisIdioma, PaisIdiomaOficial, PaisIdiomaPorcentaje) VALUES
('ABW', 'Dutch', 'T', 5.3),
('ABW', 'English', 'F', 9.5),
