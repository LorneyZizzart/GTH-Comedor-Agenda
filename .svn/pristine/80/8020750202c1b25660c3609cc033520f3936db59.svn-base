                    ...
                    <table id="example1" class="table table-bordered table-hover">
                        ...
                        <td class="text-center">
                            <div class="btn-group ">  
                                ...
                                <a href="fotografia/index.jsp?i=<%=_encript.ValorAEncriptar(Integer.toString(item.getEmpleado_id()))%>"  class="btn btn-xs btn-warning edit_button" data-toggle="tooltip" data-placement="bottom" title="Fotografia"><i class="fa fa-picture-o"></i></a>                                
