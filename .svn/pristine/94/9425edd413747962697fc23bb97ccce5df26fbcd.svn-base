        ...
        <div class="col-xs-12">            
            ...
            <div class="box box-purple">
                <div class="box-header">
                    ...
                    <button id="formNuevo" type="button" class="btn-purple btn-right_nivel" data-toggle="modal" data-target="#modal-default" data-toggle="tooltip" data-placement="bottom" title="Añadir opción">
...
<script>
    ...
    $(".formDelete").click(function (e){
        $("#titleModal").html("Eliminar Opción");
        e.preventDefault();
        e.stopImmediatePropagation();
